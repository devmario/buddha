...
{
    ::uPtr< ::app::Fuse::Controls::TextControl*>(__this->Control())->SetValue_1(text, (::uObject*)__this);
}
...
void TextViewBase__Fuse_Controls_TextControl__OnTextLayoutPropertyChanged(TextViewBase__Fuse_Controls_TextControl* __this, ::uObject* sender, ::app::Uno::EventArgs* args)
{
    ...
    {
        ::uPtr< ::app::Android::android::widget::TextView*>(__this->_textView)->setTypeface_1(::app::Fuse::Android::TypefaceCache__GetTypeface(NULL, ::uPtr< ::app::Fuse::Controls::TextControl*>(__this->Control())->Font()));
    }
    else
    {
        ::uPtr< ::app::Android::android::widget::TextView*>(__this->_textView)->setTypeface_1(::app::Android::android::graphics::Typeface__get_DEFAULT(NULL));
    }

    ::uPtr< ::app::Android::android::widget::TextView*>(__this->_textView)->setTextSize(::app::Android::android::util::TypedValue__get_COMPLEX_UNIT_DIP(NULL), ::uPtr< ::app::Fuse::Controls::TextControl*>(__this->Control())->FontSize());
...
{
    ::uPtr< ::app::Android::android::widget::TextView*>(__this->_textView)->setTextColor(::app::Fuse::Android::Helpers__EncodeColor(NULL, ::uPtr< ::app::Fuse::Controls::TextControl*>(__this->Control())->TextColor()));
}
...
void TextViewBase__Fuse_Controls_TextControl__SetText(TextViewBase__Fuse_Controls_TextControl* __this)
{
    if (::app::Uno::String__op_Inequality(NULL, ::uPtr< ::app::Fuse::Controls::TextControl*>(__this->Control())->Value(), NULL))
    {
        ...
        ::uPtr< ::app::Android::android::widget::TextView*>(__this->_textView)->setText(charSequence);
    }
    else
    {
...
{
    ::uPtr< ::app::Fuse::Controls::TextInput*>(__this->Control())->SetValue_1(text, (::uObject*)__this);
}
...
void TextViewBase__Fuse_Controls_TextInput__OnTextLayoutPropertyChanged(TextViewBase__Fuse_Controls_TextInput* __this, ::uObject* sender, ::app::Uno::EventArgs* args)
{
    ...
    {
        ::uPtr< ::app::Android::android::widget::TextView*>(__this->_textView)->setTypeface_1(::app::Fuse::Android::TypefaceCache__GetTypeface(NULL, ::uPtr< ::app::Fuse::Controls::TextInput*>(__this->Control())->Font()));
    }
    else
    {
        ::uPtr< ::app::Android::android::widget::TextView*>(__this->_textView)->setTypeface_1(::app::Android::android::graphics::Typeface__get_DEFAULT(NULL));
    ...
    ::uPtr< ::app::Android::android::widget::TextView*>(__this->_textView)->setTextSize(::app::Android::android::util::TypedValue__get_COMPLEX_UNIT_DIP(NULL), ::uPtr< ::app::Fuse::Controls::TextInput*>(__this->Control())->FontSize());
    ::uPtr< ::app::Android::android::widget::TextView*>(__this->_textView)->setTextAlignment(::app::Android::android::view::View__get_TEXT_ALIGNMENT_GRAVITY(NULL));
...
{
    ::uPtr< ::app::Android::android::widget::TextView*>(__this->_textView)->setTextColor(::app::Fuse::Android::Helpers__EncodeColor(NULL, ::uPtr< ::app::Fuse::Controls::TextInput*>(__this->Control())->TextColor()));
}

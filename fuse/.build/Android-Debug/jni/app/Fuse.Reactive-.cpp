...
AsyncFunction__uType* AsyncFunction__typeof()
{
    ...
    type->__interface_0.__fp_Call = (void(*)(void*, ::app::Fuse::Reactive::ScriptEventArgs*))AsyncFunction__Call_1;
...
{
    ::uPtr< ::app::Fuse::Reactive::ThreadWorker*>(__this->_worker)->Dispatch(0, ::uNewDelegateNonVirt(::app::Uno::Action__typeof(), (const void*)::app::Fuse::Reactive::CallEventHandler__Run, ::app::Fuse::Reactive::CallEventHandler__New_2(NULL, __this->_worker, __this->_function, args)));
}
...
CallEventHandler* CallEventHandler__New_2(::uStatic* __this, ::app::Fuse::Reactive::ThreadWorker* worker, ::app::Fuse::Scripting::Function* function, ::app::Fuse::Reactive::ScriptEventArgs* args)
{
...
::uObject* Console__Dir(::uStatic* __this, ::uArray* args)
{
    ...
    ::app::Uno::Diagnostics::Debug__Log_1(NULL, ::uPtr< ::app::Uno::Text::StringBuilder*>(builder)->ToString(), 1, ::uGetConstString("/usr/local/share/uno/Packages/Fuse.Reactive/0.10.5/$.uno"), 749);
    return NULL;
}
...
::uObject* Console__Log(::uStatic* __this, ::uArray* args)
{
    for (int i = 0; i < ::uPtr< ::uArray*>(args)->Length(); i++)
    {
        ::app::Uno::Diagnostics::Debug__Log_1(NULL, (::uPtr< ::uArray*>(args)->Item< ::uObject*>(i) != NULL) ? ::app::Uno::Object::ToString(::uPtr< ::uObject*>(::uPtr< ::uArray*>(args)->Item< ::uObject*>(i))) : ::uGetConstString("null"), 1, ::uGetConstString("/usr/local/share/uno/Packages/Fuse.Reactive/0.10.5/$.uno"), 734);
    }
...
::uObject* DebugLog__Log(::uStatic* __this, ::uArray* args)
{
    for (int i = 0; i < ::uPtr< ::uArray*>(args)->Length(); i++)
    {
        ::app::Uno::Diagnostics::Debug__Log_1(NULL, (::uPtr< ::uArray*>(args)->Item< ::uObject*>(i) != NULL) ? ::app::Uno::Object::ToString(::uPtr< ::uObject*>(::uPtr< ::uArray*>(args)->Item< ::uObject*>(i))) : ::uGetConstString("null"), 1, ::uGetConstString("/usr/local/share/uno/Packages/Fuse.Reactive/0.10.5/$.uno"), 713);
    }
...
void EventBinding__OnEvent(EventBinding* __this, ::uObject* sender, ::app::Uno::EventArgs* args)
{
    ...
    if (__this->_func != NULL)
    {
        ...
        ::app::Fuse::Reactive::IAsyncFunction::Call(::uPtr< ::uObject*>(__this->_func), sea);
    }
    else
    {
...
double Marshal__ToDouble(::uStatic* __this, ::uObject* o)
{
    ...
    {
        ::app::Uno::Diagnostics::Debug__Log_1(NULL, ::app::Uno::String__op_Addition(NULL, ::uGetConstString("Expected number was "), (::uObject*)::app::Uno::Object::GetType(::uPtr< ::uObject*>(o))), 1, ::uGetConstString("/usr/local/share/uno/Packages/Fuse.Reactive/0.10.5/$.uno"), 1822);
        return 0.0;
    }
}
...
void Marshal__ToFileSource(::uStatic* __this, ::uObject* obj, ::uDelegate* callback)
{
    ...
    {
        ::app::Uno::Diagnostics::Debug__Log_1(NULL, ::app::Uno::String__op_Addition_1(NULL, ::app::Uno::String__op_Addition(NULL, ::uGetConstString("Unable to convert "), (::uObject*)::app::Uno::Object::GetType(::uPtr< ::uObject*>(obj))), ::uGetConstString(" to a FileSource")), 1, ::uGetConstString("/usr/local/share/uno/Packages/Fuse.Reactive/0.10.5/$.uno"), 1833);
    }
}
...
void Marshal__ToType__bool(::uStatic* __this, ::uObject* o, ::uDelegate* callback)
{
    ...
    else
    {
        if (!::uIs(o, ::app::Uno::String__typeof()))
        {
            U_THROW(::app::Uno::Exception__New_2(NULL, ::app::Uno::String__op_Addition(NULL, ::app::Uno::String__op_Addition_1(NULL, ::app::Uno::String__op_Addition(NULL, ::uGetConstString("Marshal.ToType(): Unable to convert "), o), ::uGetConstString(" to type ")), (::uObject*)(::uType*)::app::Uno::Bool__typeof())));
        }
    }
}
...
void Marshal__ToType__float(::uStatic* __this, ::uObject* o, ::uDelegate* callback)
{
    ...
    else
    {
        if (!::uIs(o, ::app::Uno::String__typeof()))
        {
            U_THROW(::app::Uno::Exception__New_2(NULL, ::app::Uno::String__op_Addition(NULL, ::app::Uno::String__op_Addition_1(NULL, ::app::Uno::String__op_Addition(NULL, ::uGetConstString("Marshal.ToType(): Unable to convert "), o), ::uGetConstString(" to type ")), (::uObject*)(::uType*)::app::Uno::Float__typeof())));
        }
    }
}
...
void Marshal__ToType__Fuse_Resources_ImageSource(::uStatic* __this, ::uObject* o, ::uDelegate* callback)
{
    ...
    else
    {
        if (!::uIs(o, ::app::Uno::String__typeof()))
        {
            U_THROW(::app::Uno::Exception__New_2(NULL, ::app::Uno::String__op_Addition(NULL, ::app::Uno::String__op_Addition_1(NULL, ::app::Uno::String__op_Addition(NULL, ::uGetConstString("Marshal.ToType(): Unable to convert "), o), ::uGetConstString(" to type ")), (::uObject*)(::uType*)::app::Fuse::Resources::ImageSource__typeof())));
        }
    }
}
...
void Match__OnRooted(Match* __this, ::app::Fuse::Node* n)
{
    ...
    if (__this->_panel == NULL)
    {
        ::app::Uno::Diagnostics::Debug__Log_1(NULL, ::uGetConstString("Match can only be used on Panel (for now)"), 1, ::uGetConstString("/usr/local/share/uno/Packages/Fuse.Reactive/0.10.5/$.uno"), 1629);
    }
...
void ThreadWorker___TypeInit(::uStatic* __this)
{
    ...
    ThreadWorker__Register(NULL, ::uGetConstString("FuseJS/SubscriberProxy"), (::uObject*)::app::Fuse::Scripting::FileModule__New_1(NULL, ::app::Uno::UX::FileSource__op_Implicit(NULL, ::uCast< ::app::Uno::BundleFile*>(::app::Uno::Runtime::Implementation::Internal::BundleRegistry__Get(NULL, 530), ::app::Uno::BundleFile__typeof()))));
    ThreadWorker__Register(NULL, ::uGetConstString("FuseJS/Observable"), (::uObject*)::app::Fuse::Scripting::FileModule__New_1(NULL, ::app::Uno::UX::FileSource__op_Implicit(NULL, ::uCast< ::app::Uno::BundleFile*>(::app::Uno::Runtime::Implementation::Internal::BundleRegistry__Get(NULL, 531), ::app::Uno::BundleFile__typeof()))));
    ThreadWorker__Register(NULL, ::uGetConstString("FuseJS/Fetch"), (::uObject*)::app::Fuse::Scripting::FileModule__New_1(NULL, ::app::Uno::UX::FileSource__op_Implicit(NULL, ::uCast< ::app::Uno::BundleFile*>(::app::Uno::Runtime::Implementation::Internal::BundleRegistry__Get(NULL, 532), ::app::Uno::BundleFile__typeof()))));
    ThreadWorker__Register(NULL, ::uGetConstString("FuseJS/FetchJson"), (::uObject*)::app::Fuse::Scripting::FileModule__New_1(NULL, ::app::Uno::UX::FileSource__op_Implicit(NULL, ::uCast< ::app::Uno::BundleFile*>(::app::Uno::Runtime::Implementation::Internal::BundleRegistry__Get(NULL, 533), ::app::Uno::BundleFile__typeof()))));
    ...
    ThreadWorker__Register(NULL, ::uGetConstString("FuseJS"), (::uObject*)::app::Fuse::Scripting::FileModule__New_1(NULL, ::app::Uno::UX::FileSource__op_Implicit(NULL, ::uCast< ::app::Uno::BundleFile*>(::app::Uno::Runtime::Implementation::Internal::BundleRegistry__Get(NULL, 534), ::app::Uno::BundleFile__typeof()))));
}
...
{
    ::uPtr< ::app::Fuse::Scripting::Context*>(ThreadWorker___context)->Evaluate(::uGetConstString("browser-Window"), ::uPtr< ::app::Uno::BundleFile*>(::uCast< ::app::Uno::BundleFile*>(::app::Uno::Runtime::Implementation::Internal::BundleRegistry__Get(NULL, 536), ::app::Uno::BundleFile__typeof()))->ReadAllText());
    ::uPtr< ::app::Fuse::Scripting::Context*>(ThreadWorker___context)->Evaluate(::uGetConstString("window-Timers"), ::uPtr< ::app::Uno::BundleFile*>(::uCast< ::app::Uno::BundleFile*>(::app::Uno::Runtime::Implementation::Internal::BundleRegistry__Get(NULL, 537), ::app::Uno::BundleFile__typeof()))->ReadAllText());
    ::uPtr< ::app::Fuse::Scripting::Context*>(ThreadWorker___context)->Evaluate(::uGetConstString("window-EventTarget"), ::uPtr< ::app::Uno::BundleFile*>(::uCast< ::app::Uno::BundleFile*>(::app::Uno::Runtime::Implementation::Internal::BundleRegistry__Get(NULL, 538), ::app::Uno::BundleFile__typeof()))->ReadAllText());
    ::uPtr< ::app::Fuse::Scripting::Context*>(ThreadWorker___context)->Evaluate(::uGetConstString("window-File"), ::uPtr< ::app::Uno::BundleFile*>(::uCast< ::app::Uno::BundleFile*>(::app::Uno::Runtime::Implementation::Internal::BundleRegistry__Get(NULL, 539), ::app::Uno::BundleFile__typeof()))->ReadAllText());
    ::uPtr< ::app::Fuse::Scripting::Context*>(ThreadWorker___context)->Evaluate(::uGetConstString("window-XMLHttpRequest"), ::uPtr< ::app::Uno::BundleFile*>(::uCast< ::app::Uno::BundleFile*>(::app::Uno::Runtime::Implementation::Internal::BundleRegistry__Get(NULL, 540), ::app::Uno::BundleFile__typeof()))->ReadAllText());
    ::uPtr< ::app::Fuse::Scripting::Context*>(ThreadWorker___context)->Evaluate(::uGetConstString("window-fetch"), ::uPtr< ::app::Uno::BundleFile*>(::uCast< ::app::Uno::BundleFile*>(::app::Uno::Runtime::Implementation::Internal::BundleRegistry__Get(NULL, 541), ::app::Uno::BundleFile__typeof()))->ReadAllText());
    ::uPtr< ::app::Fuse::Scripting::Context*>(ThreadWorker___context)->Evaluate(::uGetConstString("window-localStorage"), ::uPtr< ::app::Uno::BundleFile*>(::uCast< ::app::Uno::BundleFile*>(::app::Uno::Runtime::Implementation::Internal::BundleRegistry__Get(NULL, 542), ::app::Uno::BundleFile__typeof()))->ReadAllText());
}
...
void ThreadWorker__InitBuiltInObjects(ThreadWorker* __this)
{
    ...
    ::uPtr< ::app::Fuse::Scripting::Context*>(ThreadWorker___context)->Evaluate(::uGetConstString("es6-promise"), ::uPtr< ::app::Uno::BundleFile*>(::uCast< ::app::Uno::BundleFile*>(::app::Uno::Runtime::Implementation::Internal::BundleRegistry__Get(NULL, 535), ::app::Uno::BundleFile__typeof()))->ReadAllText());

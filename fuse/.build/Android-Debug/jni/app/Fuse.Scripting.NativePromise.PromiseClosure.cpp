...
#include <app/Fuse.Scripting.NativePromise2_PromiseClosure__Fuse_Camera_Pictu-82bbe493.h>
...
::uObject* NativePromise2_PromiseClosure__bool__bool__Run(NativePromise2_PromiseClosure__bool__bool* __this, ::uArray* args)
{
    ...
    ::uPtr< ::app::Uno::Threading::Future__bool*>(__this->_promise)->Then(::uNewDelegateNonVirt(::app::Uno::Action__bool__typeof(), (const void*)NativePromise2_PromiseClosure__bool__bool__Resolve, __this), ::uNewDelegateNonVirt(::app::Uno::Action__Uno_Exception__typeof(), (const void*)NativePromise2_PromiseClosure__bool__bool__Reject, __this));
    return NULL;
}

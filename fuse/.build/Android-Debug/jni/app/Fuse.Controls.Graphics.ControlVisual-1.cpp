...
void ControlVisual__Fuse_Controls_Ellipse__OnRooted(ControlVisual__Fuse_Controls_Ellipse* __this)
{
    ...
    if ((::uObject*)__this->_control == NULL)
    {
        U_THROW(::app::Uno::Exception__New_2(NULL, ::app::Uno::String__op_Addition(NULL, ::app::Uno::String__op_Addition_2(NULL, (::uObject*)__this, ::uGetConstString(" must be rooted in the subtree of a ")), (::uObject*)(::uType*)::app::Fuse::Controls::Ellipse__typeof())));
    }
...
void ControlVisual__Fuse_Controls_Path__OnRooted(ControlVisual__Fuse_Controls_Path* __this)
{
    ...
    if ((::uObject*)__this->_control == NULL)
    {
        U_THROW(::app::Uno::Exception__New_2(NULL, ::app::Uno::String__op_Addition(NULL, ::app::Uno::String__op_Addition_2(NULL, (::uObject*)__this, ::uGetConstString(" must be rooted in the subtree of a ")), (::uObject*)(::uType*)::app::Fuse::Controls::Path__typeof())));
    }
...
void ControlVisual__Fuse_Controls_RegularPolygon__OnRooted(ControlVisual__Fuse_Controls_RegularPolygon* __this)
{
    ...
    if ((::uObject*)__this->_control == NULL)
    {
        U_THROW(::app::Uno::Exception__New_2(NULL, ::app::Uno::String__op_Addition(NULL, ::app::Uno::String__op_Addition_2(NULL, (::uObject*)__this, ::uGetConstString(" must be rooted in the subtree of a ")), (::uObject*)(::uType*)::app::Fuse::Controls::RegularPolygon__typeof())));
    }
...
void ControlVisual__Fuse_Controls_Star__OnRooted(ControlVisual__Fuse_Controls_Star* __this)
{
    ...
    if ((::uObject*)__this->_control == NULL)
    {
        U_THROW(::app::Uno::Exception__New_2(NULL, ::app::Uno::String__op_Addition(NULL, ::app::Uno::String__op_Addition_2(NULL, (::uObject*)__this, ::uGetConstString(" must be rooted in the subtree of a ")), (::uObject*)(::uType*)::app::Fuse::Controls::Star__typeof())));
    }
...
void ControlVisual__Fuse_Controls_TextControl__OnRooted(ControlVisual__Fuse_Controls_TextControl* __this)
{
    ...
    if ((::uObject*)__this->_control == NULL)
    {
        U_THROW(::app::Uno::Exception__New_2(NULL, ::app::Uno::String__op_Addition(NULL, ::app::Uno::String__op_Addition_2(NULL, (::uObject*)__this, ::uGetConstString(" must be rooted in the subtree of a ")), (::uObject*)(::uType*)::app::Fuse::Controls::TextControl__typeof())));
    }

...
// This file was generated based on '/usr/local/share/uno/Packages/Fuse.Controls/0.10.5/Internal/$.uno'.
...
void DefaultTextRenderer__DrawLine(DefaultTextRenderer* __this, ::app::Fuse::DrawContext* dc, float x, float y, ::uString* line)
{
    ...
    if (::uPtr< ::app::Fuse::DrawContext*>(dc)->ViewportPointDensity() != 1.0f)
    {
        ...
        ::uPtr< ::app::Uno::Content::Fonts::TextTransform*>(::uPtr< ::app::Uno::Content::Fonts::TextRenderer*>(DefaultTextRenderer__get_renderer(NULL))->Transform())->Matrix(::app::Uno::Matrix__Mul_10(NULL, scale, __this->_transform));
    }
    else
    {
    ...
    ::uPtr< ::app::Uno::Content::Fonts::TextRenderer*>(DefaultTextRenderer__get_renderer(NULL))->WriteString_1(p, line);
}
...
void DefaultTextRenderer__EnsureRendererCapacity(::uStatic* __this, int maxCharCount)
{
    ...
    DefaultTextRenderer___maxCharCount = ::app::Uno::Math__Max_2(NULL, DefaultTextRenderer___maxCharCount * 2, maxCharCount);
...
{
    int size = (int)::app::Uno::Math__Floor_1(NULL, ::app::Uno::Math__Clamp_8(NULL, fontSize * (includeZoom ? absoluteZoom : 1.0f), 4.0f, 400.0f));
...
float DefaultTextRenderer__GetLineHeight(DefaultTextRenderer* __this, float fontSize)
{
    ...
    float size = ::app::Uno::Math__Clamp_8(NULL, fontSize, 4.0f, 400.0f);
...
::app::Uno::Float2 DefaultTextRenderer__MeasureString(DefaultTextRenderer* __this, float fontSize, float absoluteZoom, ::uString* s)
{
    ...
    ::app::Uno::Float2 ret = ::uPtr< ::app::Uno::Content::Fonts::TextRenderer*>(DefaultTextRenderer__get_renderer(NULL))->MeasureString_1(s);
...
{
    return ::app::Uno::Matrix__Mul_10(NULL, __this->Matrix(), ::app::Fuse::IViewport::ViewProjectionTransform(::uPtr< ::uObject*>(::uPtr< ::app::Fuse::DrawContext*>(__this->DrawContext)->Viewport())));
}
...
::app::Fuse::Controls::Internal::WordWrapperWord* WordWrapper__SplitWord(::uStatic* __this, ::app::Fuse::Controls::Internal::WordWrapInfo* wrapInfo, ::app::Uno::Collections::List__Fuse_Controls_Internal_WrappedLine* wrappedLines, ::app::Fuse::Controls::Internal::WordWrapperWord* word, int* lineStartIndex)
{
    while ((::uPtr< ::uString*>(::uPtr< ::app::Fuse::Controls::Internal::WordWrapperWord*>(word)->Contents)->Length() > 1) && (::uPtr< ::app::Fuse::Controls::Internal::WordWrapperWord*>(word)->ContentsWidth > ::uPtr< ::app::Fuse::Controls::Internal::WordWrapInfo*>(wrapInfo)->WrapWidth))
    {
        ...
        {
            ::uString* leftString = ::app::Uno::String::Substring(::uPtr< ::uString*>(::uPtr< ::app::Fuse::Controls::Internal::WordWrapperWord*>(word)->Contents), 0, c);
            ...
            float endX = startX + ::uPtr< ::app::Fuse::Controls::Internal::DefaultTextRenderer*>(wrapInfo->TextRenderer)->MeasureStringVirtual(wrapInfo->FontSize, wrapInfo->AbsoluteZoom, ::app::Uno::String::Substring(::uPtr< ::uString*>(word->Contents), c, 1)).X;
...
::uArray* WordWrapper__WrapLine(::uStatic* __this, ::app::Fuse::Controls::Internal::WordWrapInfo* wrapInfo, ::uString* text)
{
    ...
    for (int i = 0; i < (::uPtr< ::app::Uno::Collections::List__Fuse_Controls_Internal_WordWrapperWord*>(words)->Count() - 1); i++)
    {
        ...
        {
            lineText = ::app::Uno::String__op_Addition_1(NULL, lineText, ::uPtr< ::app::Fuse::Controls::Internal::WordWrapperWord*>(word)->TotalContents);
            lineWidth = lineWidth + word->TotalContentsWidth;
        }
        else
        {
            ::uPtr< ::app::Uno::Collections::List__Fuse_Controls_Internal_WrappedLine*>(ret)->Add(::app::Fuse::Controls::Internal::WrappedLine__New_1(NULL, ::app::Uno::String__op_Addition_1(NULL, lineText, ::uPtr< ::app::Fuse::Controls::Internal::WordWrapperWord*>(word)->TotalContents), lineStartIndex, (float)::uPtr< ::app::Uno::Collections::List__Fuse_Controls_Internal_WrappedLine*>(ret)->Count() * ::uPtr< ::app::Fuse::Controls::Internal::WordWrapInfo*>(wrapInfo)->LineHeight, lineWidth + ::uPtr< ::app::Fuse::Controls::Internal::WordWrapperWord*>(word)->ContentsWidth));
    ...
    ::uPtr< ::app::Uno::Collections::List__Fuse_Controls_Internal_WrappedLine*>(ret)->Add(::app::Fuse::Controls::Internal::WrappedLine__New_1(NULL, ::app::Uno::String__op_Addition_1(NULL, lineText, ::uPtr< ::app::Fuse::Controls::Internal::WordWrapperWord*>(lastWord)->TotalContents), lineStartIndex, (float)::uPtr< ::app::Uno::Collections::List__Fuse_Controls_Internal_WrappedLine*>(ret)->Count() * ::uPtr< ::app::Fuse::Controls::Internal::WordWrapInfo*>(wrapInfo)->LineHeight, lineWidth + ::uPtr< ::app::Fuse::Controls::Internal::WordWrapperWord*>(lastWord)->TotalContentsWidth));
    return ret->ToArray();
}
...
void WordWrapperWord___ObjInit(WordWrapperWord* __this, ::uString* contents, ::uString* whitespace, int startIndex, float contentsWidth, float totalContentsWidth)
{
    ...
    __this->TotalContents = ::app::Uno::String__op_Addition_1(NULL, __this->Contents, __this->Whitespace);
        ...
        for (; c < ::uPtr< ::uString*>(__this->Text)->Length(); c++)
        {
            ...
            if (p >= startX)
            {
                ...
                if (p < endX)
                {
                    ...
                    if (charPos >= 0.5f)
                    {
                        c = ::app::Uno::Math__Clamp_3(NULL, c + 1, 0, ::uPtr< ::uString*>(__this->Text)->Length() - 1);
                    }
...
float WrappedLine__GetXOffset(WrappedLine* __this, int textAlignment, float boundsWidth, float absoluteZoom)
{
    switch (textAlignment)
    {
        ...
        case 1:
        {
            return ::app::Uno::Math__Round_3(NULL, ((boundsWidth - __this->LineWidth) / 2.0f) * absoluteZoom) / absoluteZoom;
        }
        case 2:
        {

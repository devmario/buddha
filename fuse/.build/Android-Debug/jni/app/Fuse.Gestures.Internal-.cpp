...
void EdgeSwiper__CalcProgress(EdgeSwiper* __this)
{
    ...
    __this->Progress(::app::Uno::Math__Clamp_7(NULL, __this->_startProgress + (double)__this->PrimaryValue(progress), 0.0, 1.0));
}
...
{
    __this->_progress = ::app::Uno::Math__Max_7(NULL, value, 0.0);

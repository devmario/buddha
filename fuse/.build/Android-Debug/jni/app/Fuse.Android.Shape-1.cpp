...
{
    __this->_shapeView = ::app::Android::android::view::View__New_6(NULL, (::app::Android::android::content::Context*)::app::Android::android::app::Activity__GetAppActivity(NULL));
...
void Shape__Fuse_Controls_Circle__OnShapeChanged(Shape__Fuse_Controls_Circle* __this)
{
    ...
    if (::app::Android::java::lang::Object__op_Equality_1(NULL, (::app::Android::java::lang::Object*)__this->_drawable, NULL) || (layerCount != ::uPtr< ::app::Android::android::graphics::drawable::LayerDrawable*>(__this->_drawable)->getNumberOfLayers()))
    {
        ...
        {
            ::uPtr< ::app::Android::Runtime::ObjectArray__Android_android_graphics_drawable_Drawable*>(list)->Item(i, (::app::Android::android::graphics::drawable::Drawable*)::app::Android::android::graphics::drawable::ShapeDrawable__New_6(NULL));
        }

        __this->_drawable = ::app::Android::android::graphics::drawable::LayerDrawable__New_6(NULL, list);
...
void Shape__Fuse_Controls_Circle__SetBrush(Shape__Fuse_Controls_Circle* __this, ::app::Android::android::graphics::drawable::ShapeDrawable* drawable, ::app::Fuse::Drawing::Brush* brush)
{
    ...
    ::app::Uno::Float4 c = ::app::Uno::Float4__New_3(NULL, 0.0f);
    ...
    if ((sc == NULL) && (ssc == NULL))
    {
        ::app::Fuse::Diagnostics__Unsupported(NULL, ::uGetConstString(""), (::uObject*)brush, ::uGetConstString("/usr/local/share/uno/Packages/Fuse.Android.Views/0.10.5/$.uno"), 2626, ::uGetConstString("SetBrush"));
    }

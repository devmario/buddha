...
void ControlView__Fuse_Controls_Button__OnGotFocus(ControlView__Fuse_Controls_Button* __this, ::uObject* s, ::uObject* a)
{
    if (::app::Android::java::lang::Object__op_Inequality_1(NULL, (::app::Android::java::lang::Object*)__this->_view, NULL))
    {
        ::uPtr< ::app::Android::android::view::View*>(__this->_view)->requestFocus_2();
    }
}
...
void ControlView__Fuse_Controls_MapView__OnRooted(ControlView__Fuse_Controls_MapView* __this)
{
    ...
    if ((::uObject*)__this->_control == NULL)
    {
        U_THROW(::app::Uno::Exception__New_2(NULL, ::app::Uno::String__op_Addition(NULL, ::app::Uno::String__op_Addition_2(NULL, (::uObject*)__this, ::uGetConstString(" must be rooted in the subtree of a ")), (::uObject*)(::uType*)::app::Fuse::Controls::MapView__typeof())));
    }
...
void ControlView__Fuse_Controls_ToggleControl__OnRooted(ControlView__Fuse_Controls_ToggleControl* __this)
{
    ...
    if ((::uObject*)__this->_control == NULL)
    {
        U_THROW(::app::Uno::Exception__New_2(NULL, ::app::Uno::String__op_Addition(NULL, ::app::Uno::String__op_Addition_2(NULL, (::uObject*)__this, ::uGetConstString(" must be rooted in the subtree of a ")), (::uObject*)(::uType*)::app::Fuse::Controls::ToggleControl__typeof())));
    }

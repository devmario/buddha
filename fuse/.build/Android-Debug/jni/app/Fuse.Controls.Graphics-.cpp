...
#include <app/Fuse.Controls.Graphics.GraphicsStyle_Fuse_Controls_ScrollView_b-7a971db.h>
#include <app/Fuse.Controls.Graphics.GraphicsStyle_Fuse_Controls_ScrollView_b-cee0b7d8.h>
#include <app/Fuse.Controls.Graphics.GraphicsStyle_Fuse_Gestures_Scroller_boo-113cb144.h>
#include <app/Fuse.Controls.Graphics.GraphicsStyle_Fuse_Triggers_WhileBool_bo-75e7d63d.h>
...
{
    if (!::uPtr< ::app::Fuse::Controls::Circle*>(__this->Circle())->HasFills() || (::app::Uno::Vector__Distance_2(NULL, ::uPtr< ::app::Fuse::HitTestContext*>(htc)->LocalPoint(), ::uPtr< ::app::Fuse::Controls::Circle*>(__this->Circle())->Center()) > ::uPtr< ::app::Fuse::Controls::Circle*>(__this->Circle())->Radius()))
    {
        return;
    }
...
::app::Uno::Float2 DefaultTextVisual__GetMarginSize(DefaultTextVisual* __this, ::app::Uno::Float2 fillSize, int fillSet)
{
    ...
    float wrapWidth = hasWrap ? ::app::Uno::Math__Max_8(NULL, fillSize.X, 0.0f) : FLT_INF;
...
void DefaultTextVisual__InitWrap(DefaultTextVisual* __this, float wrapWidth, ::uString* value)
{
    ...
    for (array_129 = __this->_wrappedLines, index_130 = 0, length_131 = ::uPtr< ::uArray*>(array_129)->Length(); index_130 < length_131; ++index_130)
    {
        ...
        maxWidth = ::app::Uno::Math__Max_8(NULL, maxWidth, ::uPtr< ::app::Fuse::Controls::Internal::WrappedLine*>(wrappedLine)->LineWidth);
...
// This file was generated based on '/usr/local/share/uno/Packages/Fuse.Controls/0.10.5/.cache/GeneratedCode/Graphics/$.uno'.
// WARNING: Changes might be lost if you edit this file directly.
...
{
    GraphicsStyle__Default = ::app::Fuse::Font__New_1(NULL, (::app::Uno::UX::FileSource*)::app::Uno::UX::BundleFileSource__New_1(NULL, ::uCast< ::app::Uno::BundleFile*>(::app::Uno::Runtime::Implementation::Internal::BundleRegistry__Get(NULL, 529), ::app::Uno::BundleFile__typeof())));
...
ImageElementDraw__uType* ImageElementDraw__typeof()
{
    ...
    type->SetStrongRefs(
        "_draw_62917c96._compiledProgram", offsetof(ImageElementDraw, _draw_62917c96._compiledProgram),
        "_draw_62917c96._constValues", offsetof(ImageElementDraw, _draw_62917c96._constValues),
        "_draw_62917c96._Program", offsetof(ImageElementDraw, _draw_62917c96._Program),
        "Draw_VertexData_62917c96_7_2_1", offsetof(ImageElementDraw, Draw_VertexData_62917c96_7_2_1));
...
{
    ::app::Uno::Float4x4 LocalTransform_62917c96_4_8_4 = ::app::Uno::Matrix__Mul_3(NULL, __this->Draw_LocalTransform_62917c96_4_8_2, ::app::Uno::Matrix__Scaling_1(NULL, size.X, size.Y, 1.0f), __this->Draw_LocalTransform_62917c96_4_8_3, ::app::Uno::Matrix__Translation(NULL, offset.X, offset.Y, 0.0f));
    {
        __this->_draw_62917c96.BlendEnabled(true);
        __this->_draw_62917c96.BlendSrcRgb(2);
        __this->_draw_62917c96.BlendDstRgb(3);
        __this->_draw_62917c96.BlendDstAlpha(3);
        __this->_draw_62917c96.DepthTestEnabled(false);
        __this->_draw_62917c96.CullFace(::uPtr< ::app::Fuse::DrawContext*>(dc)->CullFace());
        __this->_draw_62917c96.Use();
        __this->_draw_62917c96.Attrib(0, 2, __this->Draw_VertexData_62917c96_7_2_1, 8, 0);
        __this->_draw_62917c96.Uniform_2(1, ::app::Fuse::IViewport::ViewProjectionTransform(::uPtr< ::uObject*>(dc->Viewport())));
        __this->_draw_62917c96.Uniform_7(2, uvSize);
        __this->_draw_62917c96.Uniform_7(3, uvPosition);
        __this->_draw_62917c96.Uniform_5(4, Color);
        __this->_draw_62917c96.Uniform_2(5, (element != NULL) ? ::app::Uno::Matrix__Mul_10(NULL, LocalTransform_62917c96_4_8_4, ::uPtr< ::app::Fuse::Node*>(element)->WorldTransform()) : LocalTransform_62917c96_4_8_4);
        __this->_draw_62917c96.Sampler_1(6, tex);
        __this->_draw_62917c96.DrawArrays(6);
    }
}
...
{
    ::uArray* array_123;
    __this->Draw_VertexData_62917c96_7_2_1 = ::app::Uno::Graphics::VertexBuffer__New_3(NULL, ::app::Uno::Runtime::Implementation::Internal::BufferConverters__ToBuffer_8(NULL, (array_123 = ::uNewArray(::app::Uno::Float2__typeof(), 6), ::uPtr< ::uArray*>(array_123)->Item< ::app::Uno::Float2>(0) = ::app::Uno::Float2__New_2(NULL, 0.0f, 0.0f), ::uPtr< ::uArray*>(array_123)->Item< ::app::Uno::Float2>(1) = ::app::Uno::Float2__New_2(NULL, 0.0f, 1.0f), ::uPtr< ::uArray*>(array_123)->Item< ::app::Uno::Float2>(2) = ::app::Uno::Float2__New_2(NULL, 1.0f, 1.0f), ::uPtr< ::uArray*>(array_123)->Item< ::app::Uno::Float2>(3) = ::app::Uno::Float2__New_2(NULL, 0.0f, 0.0f), ::uPtr< ::uArray*>(array_123)->Item< ::app::Uno::Float2>(4) = ::app::Uno::Float2__New_2(NULL, 1.0f, 1.0f), ::uPtr< ::uArray*>(array_123)->Item< ::app::Uno::Float2>(5) = ::app::Uno::Float2__New_2(NULL, 1.0f, 0.0f), array_123)), 0);
    __this->Draw_LocalTransform_62917c96_4_8_2 = ::app::Uno::Matrix__Translation(NULL, -::app::Uno::Float2__New_1(NULL, 0.0f).X, -::app::Uno::Float2__New_1(NULL, 0.0f).Y, 0.0f);
    __this->Draw_LocalTransform_62917c96_4_8_3 = ::app::Uno::Matrix__RotationZ(NULL, 0.0f);
    __this->_draw_62917c96 = ::app::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLDrawCall__New_1(NULL, ::uCast< ::app::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram*>(::app::Uno::Runtime::Implementation::Internal::BundleRegistry__Get(NULL, 628), ::app::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram__typeof()));
}
...
::app::Uno::Float2 ImageVisual__OnArrangeMarginBox(ImageVisual* __this, ::app::Uno::Float2 position, ::app::Uno::Float2 availableSize, int fillSet)
{
    ...
    __this->_scale = ::uPtr< ::app::Fuse::Internal::SizingContainer*>(::uPtr< ::app::Fuse::Internal::ImageContainer*>(__this->Container())->Sizing)->CalcScale_1(size, contentDesiredSize);
    __this->_origin = ::uPtr< ::app::Fuse::Internal::SizingContainer*>(::uPtr< ::app::Fuse::Internal::ImageContainer*>(__this->Container())->Sizing)->CalcOrigin(size, ::app::Uno::Float2__op_Multiply_1(NULL, contentDesiredSize, __this->_scale));
...
::app::Uno::Float2 PathVisual__OnArrangeMarginBox(PathVisual* __this, ::app::Uno::Float2 position, ::app::Uno::Float2 fillSize, int fillSet)
{
    ...
    ::app::Uno::Float2 scale = ::uPtr< ::app::Fuse::Internal::SizingContainer*>(::uPtr< ::app::Fuse::Controls::Path*>(__this->Path())->Sizing())->CalcScale_1(size, contentDesiredSize);
    __this->_origin = ::uPtr< ::app::Fuse::Internal::SizingContainer*>(::uPtr< ::app::Fuse::Controls::Path*>(__this->Path())->Sizing())->CalcOrigin(size, ::app::Uno::Float2__op_Multiply_1(NULL, contentDesiredSize, scale));
...
::app::Uno::Float2 Visual__OnArrangeMarginBox(Visual* __this, ::app::Uno::Float2 position, ::app::Uno::Float2 availableSize, int availSet)
{
    ...
    if (::app::Uno::Float2__op_Inequality(NULL, __this->_position, position))
    {
...
{
    ::uPtr< ::app::Fuse::FastMatrix*>(m)->PrependTranslation(::app::Uno::Float3__New_4(NULL, __this->_position, 0.0f));
}

...
#include <app/Uno.Threading.Future1_Closure__Fuse_Camera_PictureResult__Fuse_-7661799c.h>
...
void Future__bool___ObjInit_1(Future__bool* __this, ::uObject* dispatcher)
{
...
void Future__bool___ObjInit_2(Future__bool* __this)
{
    __this->_mutex = ::app::Uno::Threading::Mutex__Create(NULL);
    __this->_ObjInit_1((::uObject*)::app::Uno::Threading::SyncDispatcher__New_1(NULL));
}
...
Future__bool* Future__bool__Then(Future__bool* __this, ::uDelegate* fulfilled, ::uDelegate* rejected)
{
    ::app::Uno::Threading::Promise__bool* chainable = ::app::Uno::Threading::Promise__bool__New_4(NULL);
    ::uPtr< ::app::Uno::Threading::Mutex*>(__this->_mutex)->Lock();
...
{
    ::app::Uno::Threading::Promise__Fuse_Camera_PictureResult* chainable = ::app::Uno::Threading::Promise__Fuse_Camera_PictureResult__New_4(NULL);
    ::uPtr< ::app::Uno::Threading::Mutex*>(__this->_mutex)->Lock();
...
{
    ::app::Uno::Threading::Promise__string* chainable = ::app::Uno::Threading::Promise__string__New_4(NULL);
    ::uPtr< ::app::Uno::Threading::Mutex*>(__this->_mutex)->Lock();

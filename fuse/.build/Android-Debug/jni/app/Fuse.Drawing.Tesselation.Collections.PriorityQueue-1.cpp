...
void PriorityQueue__Fuse_Drawing_Tesselation_Vertex__Remove(PriorityQueue__Fuse_Drawing_Tesselation_Vertex* __this, ::app::Fuse::Drawing::Tesselation::Vertex* item)
{
    ...
    U_THROW(::app::Uno::ArgumentException__New_4(NULL, ::app::Uno::String__op_Addition_1(NULL, ::app::Uno::String__op_Addition(NULL, ::uGetConstString("item "), (::uObject*)item), ::uGetConstString(" not found in queue")), ::uGetConstString("item")));
}

...
{
    if (::app::Uno::String::IndexOf(::uPtr< ::uString*>(contentType), ::uGetConstString("image/jpeg"), 0) != -1)
    {
        TextureLoader__JpegByteArrayToTexture2D(NULL, arr, callback);
    }
    else if (::app::Uno::String::IndexOf(::uPtr< ::uString*>(contentType), ::uGetConstString("image/png"), 0) != -1)
    {

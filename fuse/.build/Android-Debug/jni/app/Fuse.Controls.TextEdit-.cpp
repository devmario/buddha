...
// This file was generated based on '/usr/local/share/uno/Packages/Fuse.Controls/0.10.5/TextEdit/$.uno'.
    ...
    else
    {
        for (int i = ::uPtr< ::app::Uno::Collections::List__Fuse_Controls_TextEdit_LineCacheLine*>(__this->Lines())->Count() - 1; i >= 0; i--)
        {
            ...
            else
            {
                ...
                ::uString* start = ::app::Uno::String::Substring(::uPtr< ::uString*>(text), 0, ::uPtr< ::app::Fuse::Controls::TextEdit::TextPosition*>(::uPtr< ::app::Fuse::Controls::TextEdit::TextSpan*>(intersection)->Start)->Char);
                ::uString* end = ::app::Uno::String::Substring(text, ::uPtr< ::app::Fuse::Controls::TextEdit::TextPosition*>(intersection->End)->Char, text->Length() - ::uPtr< ::app::Fuse::Controls::TextEdit::TextPosition*>(intersection->End)->Char);
                ::uPtr< ::app::Fuse::Controls::TextEdit::LineCacheLine*>(::uPtr< ::app::Uno::Collections::List__Fuse_Controls_TextEdit_LineCacheLine*>(__this->Lines())->Item(i))->Text(::app::Uno::String__op_Addition_1(NULL, start, end));
            }
        }
    }

    __this->InvalidateText(false);
    return ::app::Fuse::Controls::TextEdit::TextPosition__New_1(NULL, ::app::Uno::Math__Min_5(NULL, ::uPtr< ::app::Fuse::Controls::TextEdit::TextPosition*>(::uPtr< ::app::Fuse::Controls::TextEdit::TextSpan*>(s)->Start)->Line, ::uPtr< ::app::Uno::Collections::List__Fuse_Controls_TextEdit_LineCacheLine*>(__this->Lines())->Count() - 1), ::uPtr< ::app::Fuse::Controls::TextEdit::TextPosition*>(::uPtr< ::app::Fuse::Controls::TextEdit::TextSpan*>(s)->Start)->Char);
}
...
::app::Fuse::Controls::TextEdit::TextPosition* LineCache__InsertNewline(LineCache* __this, ::app::Fuse::Controls::TextEdit::TextPosition* p)
{
    ...
    ::app::Fuse::Controls::TextEdit::LineCacheLine* newLine = ::app::Fuse::Controls::TextEdit::LineCacheLine__New_1(NULL, ::app::Uno::String::Substring_1(::uPtr< ::uString*>(::uPtr< ::app::Fuse::Controls::TextEdit::LineCacheLine*>(currentLine)->Text()), p->Char), __this->_transform);
    currentLine->Text(::app::Uno::String::Substring(::uPtr< ::uString*>(currentLine->Text()), 0, p->Char));
...
::app::Fuse::Controls::TextEdit::TextPosition* LineCache__TryBackspace(LineCache* __this, ::app::Fuse::Controls::TextEdit::TextPosition* p)
{
    if (::uPtr< ::app::Fuse::Controls::TextEdit::TextPosition*>(p)->Char == 0)
    {
        ...
        prevLine->Text(::app::Uno::String__op_Addition_1(NULL, prevLine->Text(), ::uPtr< ::app::Fuse::Controls::TextEdit::LineCacheLine*>(currentLine)->Text()));
...
::app::Fuse::Controls::TextEdit::TextPosition* LineCache__TryDelete(LineCache* __this, ::app::Fuse::Controls::TextEdit::TextPosition* p)
{
    ...
    if (p->Char == ::uPtr< ::uString*>(::uPtr< ::app::Fuse::Controls::TextEdit::LineCacheLine*>(line)->Text())->Length())
    {
        ...
        ::uPtr< ::app::Fuse::Controls::TextEdit::LineCacheLine*>(line)->Text(::app::Uno::String__op_Addition_1(NULL, ::uPtr< ::app::Fuse::Controls::TextEdit::LineCacheLine*>(line)->Text(), ::uPtr< ::app::Fuse::Controls::TextEdit::LineCacheLine*>(nextLine)->Text()));
...
{
    __this->Text(::app::Uno::String__op_Addition_1(NULL, ::app::Uno::String::Substring(::uPtr< ::uString*>(__this->Text()), 0, p - 1), ::app::Uno::String::Substring_1(::uPtr< ::uString*>(__this->Text()), p)));
    return p - 1;
}
...
{
    __this->Text(::app::Uno::String__op_Addition_1(NULL, ::app::Uno::String::Substring(::uPtr< ::uString*>(__this->Text()), 0, p), ::app::Uno::String::Substring_1(::uPtr< ::uString*>(__this->Text()), p + 1)));
}
...
{
    __this->Text((p < ::uPtr< ::uString*>(__this->Text())->Length()) ? ::app::Uno::String__op_Addition_1(NULL, ::app::Uno::String__op_Addition(NULL, ::app::Uno::String::Substring(::uPtr< ::uString*>(__this->Text()), 0, p), ::uBox< ::uChar>(::app::Uno::Char__typeof(), c)), ::app::Uno::String::Substring_1(::uPtr< ::uString*>(__this->Text()), p)) : ::app::Uno::String__op_Addition(NULL, __this->Text(), ::uBox< ::uChar>(::app::Uno::Char__typeof(), c)));
}
...
void TextEditVisual__DrawCaret(TextEditVisual* __this, ::app::Fuse::Controls::Internal::WordWrapInfo* wrapInfo, float textBoundsWidth, ::app::Fuse::DrawContext* dc)
{
    ...
    ::uPtr< ::app::Fuse::Drawing::SolidColor*>(__this->_caretBrush)->Color(::app::Uno::Float4__New_5(NULL, (ind_128 = ::uPtr< ::app::Fuse::Controls::TextInput*>(__this->Control())->CaretColor(), ::app::Uno::Float3__New_2(NULL, ind_128.X, ind_128.Y, ind_128.Z)), ::uPtr< ::app::Fuse::Controls::TextInput*>(__this->Control())->CaretColor().W * blink));
    ::uPtr< ::app::Fuse::Drawing::SolidColor*>(__this->_caretBrush)->Prepare(dc, caretSize);
    ::uPtr< ::app::Fuse::Drawing::Primitives::Rectangle*>(::app::Fuse::Drawing::Primitives::Rectangle__Singleton)->Fill(dc, (::app::Fuse::Node*)__this, caretSize, ::app::Uno::Float4__New_3(NULL, 0.0f), (::app::Fuse::Drawing::Brush*)__this->_caretBrush, pos, 1.0f);
}
...
{
    return ::app::Uno::Math__Max_10(NULL, __this->GetTextBoundsSize(wrapInfo), __this->ActualSize());
}
...
::app::Uno::Float2 TextEditVisual__GetMarginSize(TextEditVisual* __this, ::app::Uno::Float2 fillSize, int fillSet)
{
    ...
    float wrapWidth = ::app::Uno::Math__Max_8(NULL, fillSize.X, 0.0f);
    __this->_wrapInfo = __this->CreateWrapInfo(wrapWidth, (fillSet & 1) == 1);
    ::app::Uno::Float2 r = ::app::Uno::Float2__op_Addition(NULL, ::app::Uno::Math__Ceil_2(NULL, __this->GetTextBoundsSize(__this->_wrapInfo)), 1.0f);

    if ((fillSet & 1) == 1)
    {
        r.X = ::app::Uno::Math__Min_11(NULL, r.X, fillSize.X);
    }
...
{
    ::uPtr< ::app::Fuse::Controls::TextInput*>(__this->Control())->SetValue_1(::uPtr< ::app::Fuse::Controls::TextEdit::LineCache*>(__this->_lineCache)->Text(), (::uObject*)__this);
}
...
void TextWindow__OnDraw(TextWindow* __this, ::app::Fuse::DrawContext* dc)
{
    ...
    ::app::Uno::Float2 scaledOffset = ::app::Uno::Float2__op_Multiply_2(NULL, __this->_offset, ::uPtr< ::app::Fuse::Controls::Internal::WordWrapInfo*>(__this->_wrapInfo)->AbsoluteZoom);
    float y = 0.0f;

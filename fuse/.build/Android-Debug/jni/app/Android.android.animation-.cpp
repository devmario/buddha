...
{
    ::app::Android::android::animation::ValueAnimator___ObjInit_6(__this, ::app::Android::Base::JNI__GetDefaultObject(NULL), ::app::Android::Base::JNI__GetDefaultType(NULL), false, false);
    INIT_JNI;;
...
TimeAnimator* TimeAnimator__New_8(::uStatic* __this)
{
...
void ValueAnimator___ObjInit_6(ValueAnimator* __this, jobject obj, ::uType* utype, bool hasFallbackClass, bool resolveType)
{
    ::app::Android::android::animation::Animator___ObjInit_4(__this, obj, utype, hasFallbackClass, resolveType);
}

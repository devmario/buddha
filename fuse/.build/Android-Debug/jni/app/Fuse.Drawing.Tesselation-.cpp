...
#include <app/Fuse.Drawing.Tesselation.Collections.PriorityQueue__Fuse_Drawin-1f29301f.h>
...
// This file was generated based on '/usr/local/share/uno/Packages/Fuse.Drawing.Polygons/0.10.5/Sweep/$.uno'.
...
{
    return ::app::Uno::String__op_Addition_1(NULL, ::app::Uno::String__op_Addition(NULL, ::uGetConstString("Region of "), (::uObject*)__this->UpperEdge()), __this->fixUpperEdge() ? ::uGetConstString(" NEEDS FIX") : ::uGetConstString(""));
}
...
{
    double a = ::app::Uno::Math__Max_7(NULL, 0.0, ai);
    double b = ::app::Uno::Math__Max_7(NULL, 0.0, bi);
    return (a <= b) ? ((::app::Uno::Math__Abs_7(NULL, b) <= 9.9999997473787516e-06) ? ((x + y) / 2.0) : (x + ((y - x) * (a / (a + b))))) : (y + ((x - y) * (b / (a + b))));
}
...
{
    return __this->GoesLeft() ? ::app::Uno::String__op_Addition(NULL, ::app::Uno::String__op_Addition_1(NULL, ::app::Uno::String__op_Addition(NULL, ::uGetConstString("Left edge "), (::uObject*)__this->Destination()), ::uGetConstString(" <= ")), (::uObject*)__this->Origin()) : ::app::Uno::String__op_Addition(NULL, ::app::Uno::String__op_Addition_1(NULL, ::app::Uno::String__op_Addition(NULL, ::uGetConstString("Right edge "), (::uObject*)__this->Origin()), ::uGetConstString(" => ")), (::uObject*)__this->Destination());
}
...
void Mesh__DeleteEdge(Mesh* __this, ::app::Fuse::Drawing::Tesselation::HalfEdge* eDel)
{
    ...
    {
        U_THROW(::app::Uno::Exception__New_2(NULL, ::app::Uno::String__op_Addition(NULL, ::uGetConstString("eDel.Origin was null"), ::uBox(::app::Uno::Float2__typeof(), ::uPtr< ::app::Fuse::Drawing::Tesselation::Vertex*>(::uPtr< ::app::Fuse::Drawing::Tesselation::HalfEdge*>(eDel)->Destination())->Coords()))));
    }

    if (::uPtr< ::app::Fuse::Drawing::Tesselation::HalfEdge*>(eDel)->Destination() == NULL)
    {
        U_THROW(::app::Uno::Exception__New_2(NULL, ::app::Uno::String__op_Addition(NULL, ::uGetConstString("eDel.Destination was null "), ::uBox(::app::Uno::Float2__typeof(), ::uPtr< ::app::Fuse::Drawing::Tesselation::Vertex*>(::uPtr< ::app::Fuse::Drawing::Tesselation::HalfEdge*>(eDel)->Origin())->Coords()))));
    }
...
bool Sweep__CheckForIntersect(Sweep* __this, ::app::Fuse::Drawing::Tesselation::ActiveRegion* regUp)
{
    ...
    double tMinUp = ::app::Uno::Math__Min_10(NULL, ::uPtr< ::app::Fuse::Drawing::Tesselation::Vertex*>(orgUp)->T, ::uPtr< ::app::Fuse::Drawing::Tesselation::Vertex*>(dstUp)->T);
    double tMaxLo = ::app::Uno::Math__Max_7(NULL, ::uPtr< ::app::Fuse::Drawing::Tesselation::Vertex*>(orgLo)->T, ::uPtr< ::app::Fuse::Drawing::Tesselation::Vertex*>(dstLo)->T);
...
{
    return ::app::Uno::String__op_Addition_1(NULL, ::app::Uno::String__op_Addition(NULL, ::app::Uno::String__op_Addition_1(NULL, ::app::Uno::String__op_Addition(NULL, ::uGetConstString("["), ::uBox(::app::Uno::Double__typeof(), __this->S)), ::uGetConstString(", ")), ::uBox(::app::Uno::Double__typeof(), __this->T)), ::uGetConstString("]"));
}

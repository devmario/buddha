...
// This file was generated based on '/usr/local/share/uno/Packages/Fuse.Storage/0.10.5/$.uno'.
...
bool ApplicationDir__Delete(::uStatic* __this, ::uString* filename)
{
    ...
    ::uString* filepath = ::app::Uno::IO::Path__Combine(NULL, ::app::Uno::IO::Directory__GetUserDirectory(NULL, 1), filename);
...
{
    ::app::Uno::Threading::Promise__string* promise = ::app::Uno::Threading::Promise__string__New_4(NULL);
...
{
    ::app::Uno::Threading::Promise__bool* promise = ::app::Uno::Threading::Promise__bool__New_4(NULL);

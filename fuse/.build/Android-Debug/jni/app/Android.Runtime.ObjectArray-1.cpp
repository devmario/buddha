...
{
    __this->_ObjInit_5(::app::Android::Runtime::ObjectArrayAUX__makeArrayJObject(NULL, ::app::Uno::String::Replace_1(::uPtr< ::uString*>(::app::Uno::String::Substring_1(::uPtr< ::uString*>(::uPtr< ::uType*>(::app::Android::android::graphics::drawable::Drawable__typeof())->ToString()), 8)), ::uGetConstString("."), ::uGetConstString("/")), length), ObjectArray__Android_android_graphics_drawable_Drawable__typeof(), false, false);
}
...
::app::Android::android::graphics::drawable::Drawable* ObjectArray__Android_android_graphics_drawable_Drawable__get_Item(ObjectArray__Android_android_graphics_drawable_Drawable* __this, int i)
{
    ...
    {
        U_THROW(::app::Uno::Exception__New_2(NULL, ::app::Uno::String__op_Addition(NULL, ::app::Uno::String__op_Addition_1(NULL, ::app::Uno::String__op_Addition(NULL, ::uGetConstString("Index ("), ::uBox< int>(::app::Uno::Int__typeof(), i)), ::uGetConstString(") out of bounds for array of length ")), ::uBox< int>(::app::Uno::Int__typeof(), len))));
    }
}

...
bool EntryPoints::unoThreadLocked = false;
...
extern "C"
{
    ...
    {
        data = (jstring)::app::Android::Base::JNI__NewGlobalRef_2(NULL, (jobject)data);
...
jint JNI_OnLoad(JavaVM* vm, void* reserved)
{
    ...
    jclass activityClass = env->FindClass("com/buddha/buddha");
    jclass entryPointsClass = env->FindClass("com/buddha/ActivityNativeEntryPoints");
    jclass displayClass = env->FindClass("com/buddha/Display");
    ...
    Xli::CoreLib::Init();
    AApplication::Init();
    JniHelper::Init(vm, env, activityClass, displayClass);

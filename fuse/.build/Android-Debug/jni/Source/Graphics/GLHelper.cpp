...
void GLHelper::InitGL()
{
    ...
    LOGD("pbufferContent=%d", _eglPBufferContext);
    ...
    LOGD("surfaceContent=%d", _eglSurfaceContext);
...
void GLHelper::AssertValidContext()
{
    ...
    {
        U_THROW(::app::Uno::Exception__New_2(NULL, uNewStringUtf8("GLHelper::AssertValidContext: Invalid GL context. Not our pbuffer context or surface context",92)));
    }
}

...
struct FixedDateTimeZone : ::app::Uno::Time::DateTimeZone
{
    ...
    void _ObjInit_1(::uString* id, ::app::Uno::Time::Offset offset) { FixedDateTimeZone___ObjInit_1(this, id, offset); }
    void _ObjInit_2(::app::Uno::Time::Offset offset) { FixedDateTimeZone___ObjInit_2(this, offset); }
};

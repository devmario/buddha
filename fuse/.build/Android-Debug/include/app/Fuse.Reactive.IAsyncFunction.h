...
{
    void(*__fp_Call)(void*, ::app::Fuse::Reactive::ScriptEventArgs*);

    static void Call(::uObject* __this, ::app::Fuse::Reactive::ScriptEventArgs* ev) { ((IAsyncFunction*)uGetInterfacePtr(__this, IAsyncFunction__typeof()))->__fp_Call((::uByte*)__this + (__this->__obj_type->TypeType == uTypeTypeStruct ? sizeof(::uObject) : 0), ev); }
};

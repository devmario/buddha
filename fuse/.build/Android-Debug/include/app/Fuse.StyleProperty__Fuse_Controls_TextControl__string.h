...
#ifndef __APP_FUSE_STYLE_PROPERTY__FUSE_CONTROLS_TEXT_CONTROL__STRING_H__
#define __APP_FUSE_STYLE_PROPERTY__FUSE_CONTROLS_TEXT_CONTROL__STRING_H__
...
struct StyleProperty__Fuse_Controls_TextControl__string;

struct StyleProperty__Fuse_Controls_TextControl__string__uType : ::app::Fuse::StyleProperty__uType
{
};
...
struct StyleProperty__Fuse_Controls_TextControl__string : ::app::Fuse::StyleProperty
{
    ...
    void _ObjInit_1(::uString* defaultValue, ::uDelegate* changedCallback) { StyleProperty__Fuse_Controls_TextControl__string___ObjInit_1(this, defaultValue, changedCallback); }
    void _ObjInit_2(::uString* defaultValue, ::uDelegate* changedCallback, ::uDelegate* setter, ::uDelegate* getter) { StyleProperty__Fuse_Controls_TextControl__string___ObjInit_2(this, defaultValue, changedCallback, setter, getter); }
    ::uString* Get(::app::Fuse::Controls::TextControl* owner) { return StyleProperty__Fuse_Controls_TextControl__string__Get(this, owner); }
    bool IsEqual(::uString* value, ::uString* oldValue) { return StyleProperty__Fuse_Controls_TextControl__string__IsEqual(this, value, oldValue); }
    void OnChanged(::app::Fuse::Controls::TextControl* owner) { StyleProperty__Fuse_Controls_TextControl__string__OnChanged(this, owner); }
    bool Reset(::app::Fuse::Controls::TextControl* owner) { return StyleProperty__Fuse_Controls_TextControl__string__Reset(this, owner); }
    bool ResetStyle(::app::Fuse::Controls::TextControl* owner) { return StyleProperty__Fuse_Controls_TextControl__string__ResetStyle(this, owner); }
    bool Set(::app::Fuse::Controls::TextControl* owner, ::uString* value) { return StyleProperty__Fuse_Controls_TextControl__string__Set(this, owner, value); }
    void SetLocalState(::app::Fuse::Controls::TextControl* owner) { StyleProperty__Fuse_Controls_TextControl__string__SetLocalState(this, owner); }
};

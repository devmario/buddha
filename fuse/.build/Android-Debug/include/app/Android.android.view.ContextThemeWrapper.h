...
{
    void _ObjInit_8(jobject obj, ::uType* utype, bool hasFallbackClass, bool resolveType) { ContextThemeWrapper___ObjInit_8(this, obj, utype, hasFallbackClass, resolveType); }
};

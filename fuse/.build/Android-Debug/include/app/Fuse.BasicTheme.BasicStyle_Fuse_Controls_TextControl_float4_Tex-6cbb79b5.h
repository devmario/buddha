...
#ifndef __APP_FUSE_BASIC_THEME_BASIC_STYLE_FUSE_CONTROLS_TEXT_CONTROL_FLOAT4_TEX_6CBB79B5_H__
#define __APP_FUSE_BASIC_THEME_BASIC_STYLE_FUSE_CONTROLS_TEXT_CONTROL_FLOAT4_TEX_6CBB79B5_H__
...
struct BasicStyle_Fuse_Controls_TextControl_float4_TextColor_Property;

struct BasicStyle_Fuse_Controls_TextControl_float4_TextColor_Property__uType : ::app::Uno::UX::Property__float4__uType
{
};
...
struct BasicStyle_Fuse_Controls_TextControl_float4_TextColor_Property : ::app::Uno::UX::Property__float4
{
    ::uStrong< ::app::Fuse::Controls::TextControl*> _obj;

    void _ObjInit_1(::app::Fuse::Controls::TextControl* obj) { BasicStyle_Fuse_Controls_TextControl_float4_TextColor_Property___ObjInit_1(this, obj); }
};

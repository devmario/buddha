...
#ifndef __APP_FUSE_STYLE_PROPERTY__FUSE_CONTROLS_IMAGE__FUSE_ELEMENTS_STRETCH_SIZING_H__
#define __APP_FUSE_STYLE_PROPERTY__FUSE_CONTROLS_IMAGE__FUSE_ELEMENTS_STRETCH_SIZING_H__
...
struct StyleProperty__Fuse_Controls_Image__Fuse_Elements_StretchSizing;

struct StyleProperty__Fuse_Controls_Image__Fuse_Elements_StretchSizing__uType : ::app::Fuse::StyleProperty__uType
{
};
...
struct StyleProperty__Fuse_Controls_Image__Fuse_Elements_StretchSizing : ::app::Fuse::StyleProperty
{
    int _defaultValue;
    ...
    void _ObjInit_1(int defaultValue, ::uDelegate* changedCallback) { StyleProperty__Fuse_Controls_Image__Fuse_Elements_StretchSizing___ObjInit_1(this, defaultValue, changedCallback); }
    void _ObjInit_2(int defaultValue, ::uDelegate* changedCallback, ::uDelegate* setter, ::uDelegate* getter) { StyleProperty__Fuse_Controls_Image__Fuse_Elements_StretchSizing___ObjInit_2(this, defaultValue, changedCallback, setter, getter); }
    int Get(::app::Fuse::Controls::Image* owner) { return StyleProperty__Fuse_Controls_Image__Fuse_Elements_StretchSizing__Get(this, owner); }
    bool IsEqual(int value, int oldValue) { return StyleProperty__Fuse_Controls_Image__Fuse_Elements_StretchSizing__IsEqual(this, value, oldValue); }
    void OnChanged(::app::Fuse::Controls::Image* owner) { StyleProperty__Fuse_Controls_Image__Fuse_Elements_StretchSizing__OnChanged(this, owner); }
    bool Reset(::app::Fuse::Controls::Image* owner) { return StyleProperty__Fuse_Controls_Image__Fuse_Elements_StretchSizing__Reset(this, owner); }
    bool ResetStyle(::app::Fuse::Controls::Image* owner) { return StyleProperty__Fuse_Controls_Image__Fuse_Elements_StretchSizing__ResetStyle(this, owner); }
    bool Set(::app::Fuse::Controls::Image* owner, int value) { return StyleProperty__Fuse_Controls_Image__Fuse_Elements_StretchSizing__Set(this, owner, value); }
};

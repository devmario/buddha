...
#ifndef __APP_FUSE_BASIC_THEME_BASIC_STYLE_FUSE_ELEMENTS_ELEMENT_FLOAT_HEIGHT_PROPERTY_H__
#define __APP_FUSE_BASIC_THEME_BASIC_STYLE_FUSE_ELEMENTS_ELEMENT_FLOAT_HEIGHT_PROPERTY_H__
...
struct BasicStyle_Fuse_Elements_Element_float_Height_Property;

struct BasicStyle_Fuse_Elements_Element_float_Height_Property__uType : ::app::Uno::UX::Property__float__uType
{
};
...
struct BasicStyle_Fuse_Elements_Element_float_Height_Property : ::app::Uno::UX::Property__float
{
    ::uStrong< ::app::Fuse::Elements::Element*> _obj;

    void _ObjInit_1(::app::Fuse::Elements::Element* obj) { BasicStyle_Fuse_Elements_Element_float_Height_Property___ObjInit_1(this, obj); }
};

...
struct Node : ::uObject
{
    ...
    void ApplyStyle(::uObject* target) { Node__ApplyStyle(this, target); }
    void ApplyStyle_1() { Node__ApplyStyle_1(this); }
    ...
    bool IsRooted() { return (((Node__uType*)this->__obj_type)->__fp_get_IsRooted)(this); }
    ...
    void PerformLayout(::app::Uno::Float2 clientSize);
    void PerformLayout_1() { Node__PerformLayout_1(this); }
...
inline void Node::PerformLayout(::app::Uno::Float2 clientSize) { Node__PerformLayout(this, clientSize); }

...
struct Future__bool : ::app::Uno::Threading::Future
{
    ...
    void _ObjInit_1(::uObject* dispatcher) { Future__bool___ObjInit_1(this, dispatcher); }
    void _ObjInit_2() { Future__bool___ObjInit_2(this); }
    ...
    Future__bool* Then(::uDelegate* fulfilled, ::uDelegate* rejected) { return Future__bool__Then(this, fulfilled, rejected); }
};

...
struct SubMenu
{
    ...
    ::uObject*(*__fp_setHeaderTitle)(void*, int);
    ::uObject*(*__fp_setHeaderTitle_1)(void*, ::uObject*);
    ...
    static ::uObject* setHeaderTitle(::uObject* __this, int arg0) { return ((SubMenu*)uGetInterfacePtr(__this, SubMenu__typeof()))->__fp_setHeaderTitle((::uByte*)__this + (__this->__obj_type->TypeType == uTypeTypeStruct ? sizeof(::uObject) : 0), arg0); }
    static ::uObject* setHeaderTitle_1(::uObject* __this, ::uObject* arg0) { return ((SubMenu*)uGetInterfacePtr(__this, SubMenu__typeof()))->__fp_setHeaderTitle_1((::uByte*)__this + (__this->__obj_type->TypeType == uTypeTypeStruct ? sizeof(::uObject) : 0), arg0); }

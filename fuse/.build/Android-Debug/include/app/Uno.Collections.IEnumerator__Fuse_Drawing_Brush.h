...
struct IEnumerator__Fuse_Drawing_Brush
{
    ...
    static ::app::Fuse::Drawing::Brush* Current(::uObject* __this) { return ((IEnumerator__Fuse_Drawing_Brush*)uGetInterfacePtr(__this, IEnumerator__Fuse_Drawing_Brush__typeof()))->__fp_get_Current((::uByte*)__this + (__this->__obj_type->TypeType == uTypeTypeStruct ? sizeof(::uObject) : 0)); }
};

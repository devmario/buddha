...
#ifndef __APP_UNO_ACTION__UNO_TIME_TEXT_LOCAL_TIME_PATTERN_LOCAL_TIME_BUCKET__INT_H__
#define __APP_UNO_ACTION__UNO_TIME_TEXT_LOCAL_TIME_PATTERN_LOCAL_TIME_BUCKET__INT_H__

...
struct Property__float : ::uObject
{
    ...
    void OnAddListener(::uDelegate* listener) { Property__float__OnAddListener(this, listener); }
    float OnGet() { return (((Property__float__uType*)this->__obj_type)->__fp_OnGet)(this); }
    void OnRemoveListener(::uDelegate* listener) { Property__float__OnRemoveListener(this, listener); }

...
#ifndef __APP_FUSE_STYLE_PROPERTY__FUSE_CONTROLS_TEXT_CONTROL__FLOAT4_H__
#define __APP_FUSE_STYLE_PROPERTY__FUSE_CONTROLS_TEXT_CONTROL__FLOAT4_H__
...
struct StyleProperty__Fuse_Controls_TextControl__float4;

struct StyleProperty__Fuse_Controls_TextControl__float4__uType : ::app::Fuse::StyleProperty__uType
{
};
...
struct StyleProperty__Fuse_Controls_TextControl__float4 : ::app::Fuse::StyleProperty
{
    ...
    void _ObjInit_1(::app::Uno::Float4 defaultValue, ::uDelegate* changedCallback) { StyleProperty__Fuse_Controls_TextControl__float4___ObjInit_1(this, defaultValue, changedCallback); }
    ::app::Uno::Float4 Get(::app::Fuse::Controls::TextControl* owner) { return StyleProperty__Fuse_Controls_TextControl__float4__Get(this, owner); }
    bool HasValue(::app::Fuse::Controls::TextControl* owner) { return StyleProperty__Fuse_Controls_TextControl__float4__HasValue(this, owner); }
    bool IsEqual(::app::Uno::Float4 value, ::app::Uno::Float4 oldValue) { return StyleProperty__Fuse_Controls_TextControl__float4__IsEqual(this, value, oldValue); }
    void OnChanged(::app::Fuse::Controls::TextControl* owner) { StyleProperty__Fuse_Controls_TextControl__float4__OnChanged(this, owner); }
    bool Reset(::app::Fuse::Controls::TextControl* owner) { return StyleProperty__Fuse_Controls_TextControl__float4__Reset(this, owner); }
    bool ResetStyle(::app::Fuse::Controls::TextControl* owner) { return StyleProperty__Fuse_Controls_TextControl__float4__ResetStyle(this, owner); }
    bool Set(::app::Fuse::Controls::TextControl* owner, ::app::Uno::Float4 value) { return StyleProperty__Fuse_Controls_TextControl__float4__Set(this, owner, value); }
    bool SetStyle(::app::Fuse::Controls::TextControl* owner, ::app::Uno::Float4 value) { return StyleProperty__Fuse_Controls_TextControl__float4__SetStyle(this, owner, value); }
};

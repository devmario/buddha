...
#ifndef __APP_FUSE_I_O_S_NATIVE_STYLE_TEMPLATE_TEMPLATE2_H__
#define __APP_FUSE_I_O_S_NATIVE_STYLE_TEMPLATE_TEMPLATE2_H__
...
struct NativeStyle_Template_Template2 : ::app::Uno::UX::Template__Fuse_Controls_NativeViewHost
{
    ...
    void _ObjInit_1(::app::Fuse::iOS::NativeStyle_Template* parent) { NativeStyle_Template_Template2___ObjInit_1(this, parent); }
};

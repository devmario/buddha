...
#ifndef __APP_FUSE_STYLE_PROPERTY__FUSE_ANDROID_BUTTON__FLOAT4_H__
#define __APP_FUSE_STYLE_PROPERTY__FUSE_ANDROID_BUTTON__FLOAT4_H__

#include <app/Fuse.StyleProperty.h>
#include <app/Uno.Float4.h>
#include <Uno.h>
namespace app { namespace Fuse { namespace Android { struct Button; } } }
...
struct StyleProperty__Fuse_Android_Button__float4;

struct StyleProperty__Fuse_Android_Button__float4__uType : ::app::Fuse::StyleProperty__uType
{
};
...
struct StyleProperty__Fuse_Android_Button__float4 : ::app::Fuse::StyleProperty
{
    ...
    void _ObjInit_1(::app::Uno::Float4 defaultValue, ::uDelegate* changedCallback) { StyleProperty__Fuse_Android_Button__float4___ObjInit_1(this, defaultValue, changedCallback); }
    ::app::Uno::Float4 Get(::app::Fuse::Android::Button* owner) { return StyleProperty__Fuse_Android_Button__float4__Get(this, owner); }
    bool IsEqual(::app::Uno::Float4 value, ::app::Uno::Float4 oldValue) { return StyleProperty__Fuse_Android_Button__float4__IsEqual(this, value, oldValue); }
    void OnChanged(::app::Fuse::Android::Button* owner) { StyleProperty__Fuse_Android_Button__float4__OnChanged(this, owner); }
    bool Reset(::app::Fuse::Android::Button* owner) { return StyleProperty__Fuse_Android_Button__float4__Reset(this, owner); }
    bool ResetStyle(::app::Fuse::Android::Button* owner) { return StyleProperty__Fuse_Android_Button__float4__ResetStyle(this, owner); }
    bool Set(::app::Fuse::Android::Button* owner, ::app::Uno::Float4 value) { return StyleProperty__Fuse_Android_Button__float4__Set(this, owner, value); }
};

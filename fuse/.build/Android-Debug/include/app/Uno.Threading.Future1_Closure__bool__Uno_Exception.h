...
#ifndef __APP_UNO_THREADING_FUTURE1_CLOSURE__BOOL__UNO_EXCEPTION_H__
#define __APP_UNO_THREADING_FUTURE1_CLOSURE__BOOL__UNO_EXCEPTION_H__
...
struct Future1_Closure__bool__Uno_Exception;

struct Future1_Closure__bool__Uno_Exception__uType : ::uClassType
{
};
...
struct Future1_Closure__bool__Uno_Exception : ::uObject
{
    ::uStrong< ::uDelegate*> _action;
    ::uStrong< ::app::Uno::Exception*> _result;

    void _ObjInit(::uDelegate* action, ::app::Uno::Exception* result) { Future1_Closure__bool__Uno_Exception___ObjInit(this, action, result); }
    void Run() { Future1_Closure__bool__Uno_Exception__Run(this); }
};

...
struct Float2Buffer : ::app::Fuse::Drawing::Internal::TypedBuffer
{
    ...
    void Append(::app::Uno::Float2 value);
    void Append_1(double x, double y) { Float2Buffer__Append_1(this, x, y); }
...
inline void Float2Buffer::Append(::app::Uno::Float2 value) { Float2Buffer__Append(this, value); }

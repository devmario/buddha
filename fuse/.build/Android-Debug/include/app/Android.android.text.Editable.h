...
struct Editable
{
    ...
    ::uObject*(*__fp_append_1)(void*, ::uObject*, int, int);
    ::uObject*(*__fp_append_2)(void*, ::uObject*);
    ...
    ::uObject*(*__fp_replace)(void*, int, int, ::uObject*, int, int);
    ::uObject*(*__fp_replace_1)(void*, int, int, ::uObject*);
    ...
    static ::uObject* append_1(::uObject* __this, ::uObject* arg0, int arg1, int arg2) { return ((Editable*)uGetInterfacePtr(__this, Editable__typeof()))->__fp_append_1((::uByte*)__this + (__this->__obj_type->TypeType == uTypeTypeStruct ? sizeof(::uObject) : 0), arg0, arg1, arg2); }
    static ::uObject* append_2(::uObject* __this, ::uObject* arg0) { return ((Editable*)uGetInterfacePtr(__this, Editable__typeof()))->__fp_append_2((::uByte*)__this + (__this->__obj_type->TypeType == uTypeTypeStruct ? sizeof(::uObject) : 0), arg0); }
    ...
    static ::uObject* replace(::uObject* __this, int arg0, int arg1, ::uObject* arg2, int arg3, int arg4) { return ((Editable*)uGetInterfacePtr(__this, Editable__typeof()))->__fp_replace((::uByte*)__this + (__this->__obj_type->TypeType == uTypeTypeStruct ? sizeof(::uObject) : 0), arg0, arg1, arg2, arg3, arg4); }
    static ::uObject* replace_1(::uObject* __this, int arg0, int arg1, ::uObject* arg2) { return ((Editable*)uGetInterfacePtr(__this, Editable__typeof()))->__fp_replace_1((::uByte*)__this + (__this->__obj_type->TypeType == uTypeTypeStruct ? sizeof(::uObject) : 0), arg0, arg1, arg2); }

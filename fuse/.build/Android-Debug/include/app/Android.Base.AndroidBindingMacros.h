...
#define LOAD_SYS_CLASS(CLASSSIG) ::app::Android::Base::JNI__LoadClass_3(NULL, U_JNIVAR, CLASSSIG, false)

#define LOAD_CLASS(CLASSSIG) ::app::Android::Base::JNI__LoadClass_3(NULL, U_JNIVAR, CLASSSIG, false)

#define CHECK_JNI_EXCEPTIONS ::app::Android::Base::JNI__CheckException_2(NULL, U_JNIVAR)

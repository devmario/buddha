...
struct SurfaceHolder
{
    ...
    ::app::Android::android::graphics::Canvas*(*__fp_lockCanvas)(void*, ::app::Android::android::graphics::Rect*);
    ::app::Android::android::graphics::Canvas*(*__fp_lockCanvas_1)(void*);
    ...
    static ::app::Android::android::graphics::Canvas* lockCanvas(::uObject* __this, ::app::Android::android::graphics::Rect* arg0) { return ((SurfaceHolder*)uGetInterfacePtr(__this, SurfaceHolder__typeof()))->__fp_lockCanvas((::uByte*)__this + (__this->__obj_type->TypeType == uTypeTypeStruct ? sizeof(::uObject) : 0), arg0); }
    static ::app::Android::android::graphics::Canvas* lockCanvas_1(::uObject* __this) { return ((SurfaceHolder*)uGetInterfacePtr(__this, SurfaceHolder__typeof()))->__fp_lockCanvas_1((::uByte*)__this + (__this->__obj_type->TypeType == uTypeTypeStruct ? sizeof(::uObject) : 0)); }

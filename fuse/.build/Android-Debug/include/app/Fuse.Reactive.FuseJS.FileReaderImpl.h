...
#ifndef __APP_FUSE_REACTIVE_FUSE_J_S_FILE_READER_IMPL_H__
#define __APP_FUSE_REACTIVE_FUSE_J_S_FILE_READER_IMPL_H__
...
struct FileReaderImpl__uType : ::uClassType
{
};

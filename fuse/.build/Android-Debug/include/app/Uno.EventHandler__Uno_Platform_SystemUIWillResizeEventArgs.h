...
#ifndef __APP_UNO_EVENT_HANDLER__UNO_PLATFORM_SYSTEM_U_I_WILL_RESIZE_EVENT_ARGS_H__
#define __APP_UNO_EVENT_HANDLER__UNO_PLATFORM_SYSTEM_U_I_WILL_RESIZE_EVENT_ARGS_H__

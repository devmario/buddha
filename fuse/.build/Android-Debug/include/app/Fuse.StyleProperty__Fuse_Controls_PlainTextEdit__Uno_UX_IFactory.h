...
#ifndef __APP_FUSE_STYLE_PROPERTY__FUSE_CONTROLS_PLAIN_TEXT_EDIT__UNO_U_X_I_FACTORY_H__
#define __APP_FUSE_STYLE_PROPERTY__FUSE_CONTROLS_PLAIN_TEXT_EDIT__UNO_U_X_I_FACTORY_H__
...
struct StyleProperty__Fuse_Controls_PlainTextEdit__Uno_UX_IFactory;

struct StyleProperty__Fuse_Controls_PlainTextEdit__Uno_UX_IFactory__uType : ::app::Fuse::StyleProperty__uType
{
};
...
struct StyleProperty__Fuse_Controls_PlainTextEdit__Uno_UX_IFactory : ::app::Fuse::StyleProperty
{
    ...
    void _ObjInit_1(::uObject* defaultValue, ::uDelegate* changedCallback) { StyleProperty__Fuse_Controls_PlainTextEdit__Uno_UX_IFactory___ObjInit_1(this, defaultValue, changedCallback); }
    ::uObject* Get(::app::Fuse::Controls::PlainTextEdit* owner) { return StyleProperty__Fuse_Controls_PlainTextEdit__Uno_UX_IFactory__Get(this, owner); }
    bool HasValue(::app::Fuse::Controls::PlainTextEdit* owner) { return StyleProperty__Fuse_Controls_PlainTextEdit__Uno_UX_IFactory__HasValue(this, owner); }
    bool IsEqual(::uObject* value, ::uObject* oldValue) { return StyleProperty__Fuse_Controls_PlainTextEdit__Uno_UX_IFactory__IsEqual(this, value, oldValue); }
    void OnChanged(::app::Fuse::Controls::PlainTextEdit* owner) { StyleProperty__Fuse_Controls_PlainTextEdit__Uno_UX_IFactory__OnChanged(this, owner); }
    bool Reset(::app::Fuse::Controls::PlainTextEdit* owner) { return StyleProperty__Fuse_Controls_PlainTextEdit__Uno_UX_IFactory__Reset(this, owner); }
    bool ResetStyle(::app::Fuse::Controls::PlainTextEdit* owner) { return StyleProperty__Fuse_Controls_PlainTextEdit__Uno_UX_IFactory__ResetStyle(this, owner); }
    bool Set(::app::Fuse::Controls::PlainTextEdit* owner, ::uObject* value) { return StyleProperty__Fuse_Controls_PlainTextEdit__Uno_UX_IFactory__Set(this, owner, value); }
    bool SetStyle(::app::Fuse::Controls::PlainTextEdit* owner, ::uObject* value) { return StyleProperty__Fuse_Controls_PlainTextEdit__Uno_UX_IFactory__SetStyle(this, owner, value); }
};

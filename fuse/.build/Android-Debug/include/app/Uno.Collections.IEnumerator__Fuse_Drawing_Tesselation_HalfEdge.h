...
struct IEnumerator__Fuse_Drawing_Tesselation_HalfEdge
{
    ...
    static ::app::Fuse::Drawing::Tesselation::HalfEdge* Current(::uObject* __this) { return ((IEnumerator__Fuse_Drawing_Tesselation_HalfEdge*)uGetInterfacePtr(__this, IEnumerator__Fuse_Drawing_Tesselation_HalfEdge__typeof()))->__fp_get_Current((::uByte*)__this + (__this->__obj_type->TypeType == uTypeTypeStruct ? sizeof(::uObject) : 0)); }
};

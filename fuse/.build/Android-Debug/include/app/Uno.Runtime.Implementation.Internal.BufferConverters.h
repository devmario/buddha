...
#ifndef __APP_UNO_RUNTIME_IMPLEMENTATION_INTERNAL_BUFFER_CONVERTERS_H__
#define __APP_UNO_RUNTIME_IMPLEMENTATION_INTERNAL_BUFFER_CONVERTERS_H__
...
struct BufferConverters__uType : ::uClassType
{
};

...
#ifndef __APP_UNO_TIME_TEXT_PATTERN_PART__UNO_TIME_TEXT_OFFSET_PATTERN_OFFSET_BUCKET__INT_H__
#define __APP_UNO_TIME_TEXT_PATTERN_PART__UNO_TIME_TEXT_OFFSET_PATTERN_OFFSET_BUCKET__INT_H__
...
struct PatternPart__Uno_Time_Text_OffsetPattern_OffsetBucket__int;

struct PatternPart__Uno_Time_Text_OffsetPattern_OffsetBucket__int__uType : ::uClassType
{
    ::app::Uno::Time::Text::IPatternPart__Uno_Time_Text_OffsetPattern_OffsetBucket __interface_0;
    ::uString*(*__fp_Write)(PatternPart__Uno_Time_Text_OffsetPattern_OffsetBucket__int*, ::app::Uno::Time::Text::OffsetPattern_OffsetBucket*);
};
...
struct PatternPart__Uno_Time_Text_OffsetPattern_OffsetBucket__int : ::uObject
{
    ...
    void _ObjInit() { PatternPart__Uno_Time_Text_OffsetPattern_OffsetBucket__int___ObjInit(this); }
    int Get(::app::Uno::Time::Text::OffsetPattern_OffsetBucket* bucket) { return PatternPart__Uno_Time_Text_OffsetPattern_OffsetBucket__int__Get(this, bucket); }
    int ExpectedSize() { return PatternPart__Uno_Time_Text_OffsetPattern_OffsetBucket__int__get_ExpectedSize(this); }
    ::uDelegate* Getter() { return PatternPart__Uno_Time_Text_OffsetPattern_OffsetBucket__int__get_Getter(this); }
    bool Obligatory() { return PatternPart__Uno_Time_Text_OffsetPattern_OffsetBucket__int__get_Obligatory(this); }
    ::uDelegate* Setter() { return PatternPart__Uno_Time_Text_OffsetPattern_OffsetBucket__int__get_Setter(this); }
    void ExpectedSize(int value) { PatternPart__Uno_Time_Text_OffsetPattern_OffsetBucket__int__set_ExpectedSize(this, value); }
    void Getter(::uDelegate* value) { PatternPart__Uno_Time_Text_OffsetPattern_OffsetBucket__int__set_Getter(this, value); }
    void Obligatory(bool value) { PatternPart__Uno_Time_Text_OffsetPattern_OffsetBucket__int__set_Obligatory(this, value); }
    void Setter(::uDelegate* value) { PatternPart__Uno_Time_Text_OffsetPattern_OffsetBucket__int__set_Setter(this, value); }
    ::uString* Write(::app::Uno::Time::Text::OffsetPattern_OffsetBucket* value) { return (((PatternPart__Uno_Time_Text_OffsetPattern_OffsetBucket__int__uType*)this->__obj_type)->__fp_Write)(this, value); }
};

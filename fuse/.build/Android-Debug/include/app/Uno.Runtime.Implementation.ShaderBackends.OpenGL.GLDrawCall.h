...
struct GLDrawCall
{
    ...
    void Attrib(int index, int type, ::app::Uno::Graphics::VertexBuffer* buf, int stride, int offset) { GLDrawCall__Attrib(this, index, type, buf, stride, offset); }
    void Attrib_1(int index, int componentCount, int componentType, bool normalized, ::app::Uno::Graphics::VertexBuffer* buf, int stride, int offset) { GLDrawCall__Attrib_1(this, index, componentCount, componentType, normalized, buf, stride, offset); }
    void Begin() { GLDrawCall__Begin(this); }
    void Const(int index, int value) { GLDrawCall__Const(this, index, value); }
    void Const_1(int index, bool value) { GLDrawCall__Const_1(this, index, value); }
    ...
    void Sampler(int index, ::app::Uno::Graphics::Texture2D* value, ::app::Uno::Graphics::SamplerState state);
    void Sampler_1(int index, ::app::Uno::Graphics::Texture2D* value) { GLDrawCall__Sampler_1(this, index, value); }
    void Sampler_2(int index, int target, ::uUInt handle, ::app::Uno::Graphics::SamplerState state, bool supportsMipmap);
    void Sampler_3(int index, int target, ::uUInt handle, bool supportsMipmap) { GLDrawCall__Sampler_3(this, index, target, handle, supportsMipmap); }
    ...
    void Uniform_1(int index, ::uArray* value) { GLDrawCall__Uniform_1(this, index, value); }
    void Uniform_13(int index, ::uArray* value) { GLDrawCall__Uniform_13(this, index, value); }
    void Uniform_2(int index, ::app::Uno::Float4x4 value);
    void Uniform_4(int index, ::app::Uno::Float2x2 value);
    void Uniform_5(int index, ::app::Uno::Float4 value);
    void Uniform_6(int index, ::app::Uno::Float3 value);
    void Uniform_7(int index, ::app::Uno::Float2 value);
...
inline void GLDrawCall::Sampler(int index, ::app::Uno::Graphics::Texture2D* value, ::app::Uno::Graphics::SamplerState state) { GLDrawCall__Sampler(this, index, value, state); }
inline void GLDrawCall::Sampler_2(int index, int target, ::uUInt handle, ::app::Uno::Graphics::SamplerState state, bool supportsMipmap) { GLDrawCall__Sampler_2(this, index, target, handle, state, supportsMipmap); }
inline void GLDrawCall::Uniform_2(int index, ::app::Uno::Float4x4 value) { GLDrawCall__Uniform_2(this, index, value); }
inline void GLDrawCall::Uniform_4(int index, ::app::Uno::Float2x2 value) { GLDrawCall__Uniform_4(this, index, value); }
inline void GLDrawCall::Uniform_5(int index, ::app::Uno::Float4 value) { GLDrawCall__Uniform_5(this, index, value); }
inline void GLDrawCall::Uniform_6(int index, ::app::Uno::Float3 value) { GLDrawCall__Uniform_6(this, index, value); }
inline void GLDrawCall::Uniform_7(int index, ::app::Uno::Float2 value) { GLDrawCall__Uniform_7(this, index, value); }

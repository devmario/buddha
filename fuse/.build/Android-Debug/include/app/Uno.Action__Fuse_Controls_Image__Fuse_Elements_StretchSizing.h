...
#ifndef __APP_UNO_ACTION__FUSE_CONTROLS_IMAGE__FUSE_ELEMENTS_STRETCH_SIZING_H__
#define __APP_UNO_ACTION__FUSE_CONTROLS_IMAGE__FUSE_ELEMENTS_STRETCH_SIZING_H__

...
struct Property__bool : ::uObject
{
    ...
    void OnAddListener(::uDelegate* listener) { Property__bool__OnAddListener(this, listener); }
    bool OnGet() { return (((Property__bool__uType*)this->__obj_type)->__fp_OnGet)(this); }
    void OnRemoveListener(::uDelegate* listener) { Property__bool__OnRemoveListener(this, listener); }

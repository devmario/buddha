...
#ifndef __APP_FUSE_STYLE_PROPERTY__FUSE_CONTROLS_STACK_PANEL__FLOAT_H__
#define __APP_FUSE_STYLE_PROPERTY__FUSE_CONTROLS_STACK_PANEL__FLOAT_H__
...
struct StyleProperty__Fuse_Controls_StackPanel__float;

struct StyleProperty__Fuse_Controls_StackPanel__float__uType : ::app::Fuse::StyleProperty__uType
{
};
...
struct StyleProperty__Fuse_Controls_StackPanel__float : ::app::Fuse::StyleProperty
{
    float _defaultValue;
    ...
    void _ObjInit_1(float defaultValue, ::uDelegate* changedCallback) { StyleProperty__Fuse_Controls_StackPanel__float___ObjInit_1(this, defaultValue, changedCallback); }
    float Get(::app::Fuse::Controls::StackPanel* owner) { return StyleProperty__Fuse_Controls_StackPanel__float__Get(this, owner); }
    bool IsEqual(float value, float oldValue) { return StyleProperty__Fuse_Controls_StackPanel__float__IsEqual(this, value, oldValue); }
    void OnChanged(::app::Fuse::Controls::StackPanel* owner) { StyleProperty__Fuse_Controls_StackPanel__float__OnChanged(this, owner); }
    bool Reset(::app::Fuse::Controls::StackPanel* owner) { return StyleProperty__Fuse_Controls_StackPanel__float__Reset(this, owner); }
    bool ResetStyle(::app::Fuse::Controls::StackPanel* owner) { return StyleProperty__Fuse_Controls_StackPanel__float__ResetStyle(this, owner); }
    bool Set(::app::Fuse::Controls::StackPanel* owner, float value) { return StyleProperty__Fuse_Controls_StackPanel__float__Set(this, owner, value); }
};

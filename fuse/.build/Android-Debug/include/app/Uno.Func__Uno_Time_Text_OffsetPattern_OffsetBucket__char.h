...
#ifndef __APP_UNO_FUNC__UNO_TIME_TEXT_OFFSET_PATTERN_OFFSET_BUCKET__CHAR_H__
#define __APP_UNO_FUNC__UNO_TIME_TEXT_OFFSET_PATTERN_OFFSET_BUCKET__CHAR_H__

...
#ifndef __APP_FUSE_NAVIGATION_WEB_VIEW_NAVIGATION_EXTENSIONS_H__
#define __APP_FUSE_NAVIGATION_WEB_VIEW_NAVIGATION_EXTENSIONS_H__
...
struct WebViewNavigationExtensions__uType : ::uClassType
{
};

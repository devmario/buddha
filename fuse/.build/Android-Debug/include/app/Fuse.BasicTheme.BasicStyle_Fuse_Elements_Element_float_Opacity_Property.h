...
#ifndef __APP_FUSE_BASIC_THEME_BASIC_STYLE_FUSE_ELEMENTS_ELEMENT_FLOAT_OPACITY_PROPERTY_H__
#define __APP_FUSE_BASIC_THEME_BASIC_STYLE_FUSE_ELEMENTS_ELEMENT_FLOAT_OPACITY_PROPERTY_H__
...
struct BasicStyle_Fuse_Elements_Element_float_Opacity_Property;

struct BasicStyle_Fuse_Elements_Element_float_Opacity_Property__uType : ::app::Uno::UX::Property__float__uType
{
};
...
struct BasicStyle_Fuse_Elements_Element_float_Opacity_Property : ::app::Uno::UX::Property__float
{
    ::uStrong< ::app::Fuse::Elements::Element*> _obj;

    void _ObjInit_1(::app::Fuse::Elements::Element* obj) { BasicStyle_Fuse_Elements_Element_float_Opacity_Property___ObjInit_1(this, obj); }
};

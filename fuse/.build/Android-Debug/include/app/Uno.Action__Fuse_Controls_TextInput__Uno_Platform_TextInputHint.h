...
#ifndef __APP_UNO_ACTION__FUSE_CONTROLS_TEXT_INPUT__UNO_PLATFORM_TEXT_INPUT_HINT_H__
#define __APP_UNO_ACTION__FUSE_CONTROLS_TEXT_INPUT__UNO_PLATFORM_TEXT_INPUT_HINT_H__

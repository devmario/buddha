...
#ifndef __APP_UNO_FUNC__FUSE_CONTROLS_IMAGE__FUSE_ELEMENTS_STRETCH_DIRECTION_H__
#define __APP_UNO_FUNC__FUSE_CONTROLS_IMAGE__FUSE_ELEMENTS_STRETCH_DIRECTION_H__

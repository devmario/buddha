...
#ifndef __APP_UNO_ACTION__FUSE_CONTROLS_SCROLL_VIEW__FUSE_GESTURES_SCROLL_DIRECTIONS_H__
#define __APP_UNO_ACTION__FUSE_CONTROLS_SCROLL_VIEW__FUSE_GESTURES_SCROLL_DIRECTIONS_H__

...
#ifndef __APP_FUSE_STYLE_PROPERTY__FUSE_CONTROLS_SHAPE__FLOAT_H__
#define __APP_FUSE_STYLE_PROPERTY__FUSE_CONTROLS_SHAPE__FLOAT_H__
...
struct StyleProperty__Fuse_Controls_Shape__float;

struct StyleProperty__Fuse_Controls_Shape__float__uType : ::app::Fuse::StyleProperty__uType
{
};
...
struct StyleProperty__Fuse_Controls_Shape__float : ::app::Fuse::StyleProperty
{
    float _defaultValue;
    ...
    void _ObjInit_1(float defaultValue, ::uDelegate* changedCallback) { StyleProperty__Fuse_Controls_Shape__float___ObjInit_1(this, defaultValue, changedCallback); }
    void _ObjInit_2(float defaultValue, ::uDelegate* changedCallback, ::uDelegate* setter, ::uDelegate* getter) { StyleProperty__Fuse_Controls_Shape__float___ObjInit_2(this, defaultValue, changedCallback, setter, getter); }
    float Get(::app::Fuse::Controls::Shape* owner) { return StyleProperty__Fuse_Controls_Shape__float__Get(this, owner); }
    bool IsEqual(float value, float oldValue) { return StyleProperty__Fuse_Controls_Shape__float__IsEqual(this, value, oldValue); }
    void OnChanged(::app::Fuse::Controls::Shape* owner) { StyleProperty__Fuse_Controls_Shape__float__OnChanged(this, owner); }
    bool Reset(::app::Fuse::Controls::Shape* owner) { return StyleProperty__Fuse_Controls_Shape__float__Reset(this, owner); }
    bool ResetStyle(::app::Fuse::Controls::Shape* owner) { return StyleProperty__Fuse_Controls_Shape__float__ResetStyle(this, owner); }
    bool Set(::app::Fuse::Controls::Shape* owner, float value) { return StyleProperty__Fuse_Controls_Shape__float__Set(this, owner, value); }
};

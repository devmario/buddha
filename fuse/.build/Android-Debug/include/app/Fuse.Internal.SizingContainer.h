...
struct SizingContainer : ::uObject
{
    ...
    ::app::Uno::Float2 CalcScale(::app::Uno::Float2 availableSize, ::app::Uno::Float2 desiredSize, bool autoWidth, bool autoHeight);
    ::app::Uno::Float2 CalcScale_1(::app::Uno::Float2 availableSize, ::app::Uno::Float2 desiredSize);
...
inline ::app::Uno::Float2 SizingContainer::CalcScale(::app::Uno::Float2 availableSize, ::app::Uno::Float2 desiredSize, bool autoWidth, bool autoHeight) { return SizingContainer__CalcScale(this, availableSize, desiredSize, autoWidth, autoHeight); }
inline ::app::Uno::Float2 SizingContainer::CalcScale_1(::app::Uno::Float2 availableSize, ::app::Uno::Float2 desiredSize) { return SizingContainer__CalcScale_1(this, availableSize, desiredSize); }

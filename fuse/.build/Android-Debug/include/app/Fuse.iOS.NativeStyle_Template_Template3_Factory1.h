...
#ifndef __APP_FUSE_I_O_S_NATIVE_STYLE_TEMPLATE_TEMPLATE3_FACTORY1_H__
#define __APP_FUSE_I_O_S_NATIVE_STYLE_TEMPLATE_TEMPLATE3_FACTORY1_H__
...
struct NativeStyle_Template_Template3_Factory1 : ::uObject
{
    ...
    void _ObjInit(::app::Fuse::iOS::NativeStyle_Template_Template3* parent) { NativeStyle_Template_Template3_Factory1___ObjInit(this, parent); }

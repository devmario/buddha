...
#ifndef __APP_ANDROID_RUNTIME_NATIVE_ACTIVITY_HELPER_H__
#define __APP_ANDROID_RUNTIME_NATIVE_ACTIVITY_HELPER_H__
...
struct NativeActivityHelper__uType : ::uClassType
{
};

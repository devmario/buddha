...
struct TextControl : ::app::Fuse::Controls::Panel
{
    ...
    void OnTextLayoutPropertyChanged_1() { TextControl__OnTextLayoutPropertyChanged_1(this); }
    void OnTextRenderPropertyChanged_1() { TextControl__OnTextRenderPropertyChanged_1(this); }
    ...
    void SetValue_1(::uString* value, ::uObject* origin) { TextControl__SetValue_1(this, value, origin); }
};

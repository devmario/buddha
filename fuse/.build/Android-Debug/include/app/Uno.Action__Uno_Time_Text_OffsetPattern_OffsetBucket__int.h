...
#ifndef __APP_UNO_ACTION__UNO_TIME_TEXT_OFFSET_PATTERN_OFFSET_BUCKET__INT_H__
#define __APP_UNO_ACTION__UNO_TIME_TEXT_OFFSET_PATTERN_OFFSET_BUCKET__INT_H__

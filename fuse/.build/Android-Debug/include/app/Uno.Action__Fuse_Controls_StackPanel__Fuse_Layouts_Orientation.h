...
#ifndef __APP_UNO_ACTION__FUSE_CONTROLS_STACK_PANEL__FUSE_LAYOUTS_ORIENTATION_H__
#define __APP_UNO_ACTION__FUSE_CONTROLS_STACK_PANEL__FUSE_LAYOUTS_ORIENTATION_H__

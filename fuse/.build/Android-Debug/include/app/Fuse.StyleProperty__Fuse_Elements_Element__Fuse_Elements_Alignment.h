...
#ifndef __APP_FUSE_STYLE_PROPERTY__FUSE_ELEMENTS_ELEMENT__FUSE_ELEMENTS_ALIGNMENT_H__
#define __APP_FUSE_STYLE_PROPERTY__FUSE_ELEMENTS_ELEMENT__FUSE_ELEMENTS_ALIGNMENT_H__
...
struct StyleProperty__Fuse_Elements_Element__Fuse_Elements_Alignment;

struct StyleProperty__Fuse_Elements_Element__Fuse_Elements_Alignment__uType : ::app::Fuse::StyleProperty__uType
{
};
...
struct StyleProperty__Fuse_Elements_Element__Fuse_Elements_Alignment : ::app::Fuse::StyleProperty
{
    int _defaultValue;
    ...
    void _ObjInit_1(int defaultValue, ::uDelegate* changedCallback) { StyleProperty__Fuse_Elements_Element__Fuse_Elements_Alignment___ObjInit_1(this, defaultValue, changedCallback); }
    int Get(::app::Fuse::Elements::Element* owner) { return StyleProperty__Fuse_Elements_Element__Fuse_Elements_Alignment__Get(this, owner); }
    bool HasValue(::app::Fuse::Elements::Element* owner) { return StyleProperty__Fuse_Elements_Element__Fuse_Elements_Alignment__HasValue(this, owner); }
    bool IsEqual(int value, int oldValue) { return StyleProperty__Fuse_Elements_Element__Fuse_Elements_Alignment__IsEqual(this, value, oldValue); }
    void OnChanged(::app::Fuse::Elements::Element* owner) { StyleProperty__Fuse_Elements_Element__Fuse_Elements_Alignment__OnChanged(this, owner); }
    bool Reset(::app::Fuse::Elements::Element* owner) { return StyleProperty__Fuse_Elements_Element__Fuse_Elements_Alignment__Reset(this, owner); }
    bool ResetStyle(::app::Fuse::Elements::Element* owner) { return StyleProperty__Fuse_Elements_Element__Fuse_Elements_Alignment__ResetStyle(this, owner); }
    bool Set(::app::Fuse::Elements::Element* owner, int value) { return StyleProperty__Fuse_Elements_Element__Fuse_Elements_Alignment__Set(this, owner, value); }
    bool SetStyle(::app::Fuse::Elements::Element* owner, int value) { return StyleProperty__Fuse_Elements_Element__Fuse_Elements_Alignment__SetStyle(this, owner, value); }
};

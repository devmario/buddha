...
struct IEnumerable__Fuse_Drawing_Tesselation_Face
{
    ...
    static ::uObject* GetEnumerator(::uObject* __this) { return ((IEnumerable__Fuse_Drawing_Tesselation_Face*)uGetInterfacePtr(__this, IEnumerable__Fuse_Drawing_Tesselation_Face__typeof()))->__fp_GetEnumerator((::uByte*)__this + (__this->__obj_type->TypeType == uTypeTypeStruct ? sizeof(::uObject) : 0)); }
};

...
#ifndef __APP_FUSE_STYLE_PROPERTY__FUSE_SHAPES_SHAPE__FUSE_DRAWING_STROKE_H__
#define __APP_FUSE_STYLE_PROPERTY__FUSE_SHAPES_SHAPE__FUSE_DRAWING_STROKE_H__
...
struct StyleProperty__Fuse_Shapes_Shape__Fuse_Drawing_Stroke;

struct StyleProperty__Fuse_Shapes_Shape__Fuse_Drawing_Stroke__uType : ::app::Fuse::StyleProperty__uType
{
};
...
struct StyleProperty__Fuse_Shapes_Shape__Fuse_Drawing_Stroke : ::app::Fuse::StyleProperty
{
    ...
    void _ObjInit_1(::app::Fuse::Drawing::Stroke* defaultValue, ::uDelegate* changedCallback) { StyleProperty__Fuse_Shapes_Shape__Fuse_Drawing_Stroke___ObjInit_1(this, defaultValue, changedCallback); }
    void _ObjInit_2(::app::Fuse::Drawing::Stroke* defaultValue, ::uDelegate* changedCallback, ::uDelegate* setter, ::uDelegate* getter) { StyleProperty__Fuse_Shapes_Shape__Fuse_Drawing_Stroke___ObjInit_2(this, defaultValue, changedCallback, setter, getter); }
    void OnChanged(::app::Fuse::Shapes::Shape* owner) { StyleProperty__Fuse_Shapes_Shape__Fuse_Drawing_Stroke__OnChanged(this, owner); }
    bool Reset(::app::Fuse::Shapes::Shape* owner) { return StyleProperty__Fuse_Shapes_Shape__Fuse_Drawing_Stroke__Reset(this, owner); }
    bool ResetStyle(::app::Fuse::Shapes::Shape* owner) { return StyleProperty__Fuse_Shapes_Shape__Fuse_Drawing_Stroke__ResetStyle(this, owner); }
};

...
#ifndef __APP_FUSE_BASIC_THEME_BASIC_STYLE_FUSE_INPUT_FOCUS_BOOL_FOCUS_IS_FOCUSA_65A8C044_H__
#define __APP_FUSE_BASIC_THEME_BASIC_STYLE_FUSE_INPUT_FOCUS_BOOL_FOCUS_IS_FOCUSA_65A8C044_H__
...
struct BasicStyle_Fuse_Input_Focus_bool_Focus_IsFocusable_Property;

struct BasicStyle_Fuse_Input_Focus_bool_Focus_IsFocusable_Property__uType : ::app::Uno::UX::Property__bool__uType
{
};
...
struct BasicStyle_Fuse_Input_Focus_bool_Focus_IsFocusable_Property : ::app::Uno::UX::Property__bool
{
    ::uStrong< ::app::Fuse::Node*> _obj;

    void _ObjInit_1(::app::Fuse::Node* obj) { BasicStyle_Fuse_Input_Focus_bool_Focus_IsFocusable_Property___ObjInit_1(this, obj); }
};

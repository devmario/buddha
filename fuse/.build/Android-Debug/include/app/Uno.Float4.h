...
struct Float4
{
    ...
    void _ObjInit(::app::Uno::Float2 xy, float z, float w);
    void _ObjInit_1(float x, float y, float z, float w) { Float4___ObjInit_1(this, x, y, z, w); }
    void _ObjInit_2(float xyzw) { Float4___ObjInit_2(this, xyzw); }
    void _ObjInit_5(::app::Uno::Float3 xyz, float w);
...
inline void Float4::_ObjInit(::app::Uno::Float2 xy, float z, float w) { Float4___ObjInit(this, xy, z, w); }
inline void Float4::_ObjInit_5(::app::Uno::Float3 xyz, float w) { Float4___ObjInit_5(this, xyz, w); }

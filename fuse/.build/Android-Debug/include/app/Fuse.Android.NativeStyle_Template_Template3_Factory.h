...
#ifndef __APP_FUSE_ANDROID_NATIVE_STYLE_TEMPLATE_TEMPLATE3_FACTORY_H__
#define __APP_FUSE_ANDROID_NATIVE_STYLE_TEMPLATE_TEMPLATE3_FACTORY_H__
...
struct NativeStyle_Template_Template3_Factory : ::uObject
{
    ...
    void _ObjInit(::app::Fuse::Android::NativeStyle_Template_Template3* parent) { NativeStyle_Template_Template3_Factory___ObjInit(this, parent); }

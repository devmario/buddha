...
struct IEnumerable__Fuse_Drawing_Border
{
    ...
    static ::uObject* GetEnumerator(::uObject* __this) { return ((IEnumerable__Fuse_Drawing_Border*)uGetInterfacePtr(__this, IEnumerable__Fuse_Drawing_Border__typeof()))->__fp_GetEnumerator((::uByte*)__this + (__this->__obj_type->TypeType == uTypeTypeStruct ? sizeof(::uObject) : 0)); }
};

...
#ifndef __APP_UNO_FUNC__FUSE_CONTROLS_PLAIN_TEXT_EDIT__UNO_U_X_I_FACTORY_H__
#define __APP_UNO_FUNC__FUSE_CONTROLS_PLAIN_TEXT_EDIT__UNO_U_X_I_FACTORY_H__

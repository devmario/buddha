...
#ifndef __APP_FUSE_STYLE_PROPERTY__FUSE_CONTROLS_IMAGE__FUSE_ELEMENTS_ALIGNMENT_H__
#define __APP_FUSE_STYLE_PROPERTY__FUSE_CONTROLS_IMAGE__FUSE_ELEMENTS_ALIGNMENT_H__
...
struct StyleProperty__Fuse_Controls_Image__Fuse_Elements_Alignment;

struct StyleProperty__Fuse_Controls_Image__Fuse_Elements_Alignment__uType : ::app::Fuse::StyleProperty__uType
{
};
...
struct StyleProperty__Fuse_Controls_Image__Fuse_Elements_Alignment : ::app::Fuse::StyleProperty
{
    int _defaultValue;
    ...
    void _ObjInit_1(int defaultValue, ::uDelegate* changedCallback) { StyleProperty__Fuse_Controls_Image__Fuse_Elements_Alignment___ObjInit_1(this, defaultValue, changedCallback); }
    void _ObjInit_2(int defaultValue, ::uDelegate* changedCallback, ::uDelegate* setter, ::uDelegate* getter) { StyleProperty__Fuse_Controls_Image__Fuse_Elements_Alignment___ObjInit_2(this, defaultValue, changedCallback, setter, getter); }
    int Get(::app::Fuse::Controls::Image* owner) { return StyleProperty__Fuse_Controls_Image__Fuse_Elements_Alignment__Get(this, owner); }
    bool IsEqual(int value, int oldValue) { return StyleProperty__Fuse_Controls_Image__Fuse_Elements_Alignment__IsEqual(this, value, oldValue); }
    void OnChanged(::app::Fuse::Controls::Image* owner) { StyleProperty__Fuse_Controls_Image__Fuse_Elements_Alignment__OnChanged(this, owner); }
    bool Reset(::app::Fuse::Controls::Image* owner) { return StyleProperty__Fuse_Controls_Image__Fuse_Elements_Alignment__Reset(this, owner); }
    bool ResetStyle(::app::Fuse::Controls::Image* owner) { return StyleProperty__Fuse_Controls_Image__Fuse_Elements_Alignment__ResetStyle(this, owner); }
    bool Set(::app::Fuse::Controls::Image* owner, int value) { return StyleProperty__Fuse_Controls_Image__Fuse_Elements_Alignment__Set(this, owner, value); }
};

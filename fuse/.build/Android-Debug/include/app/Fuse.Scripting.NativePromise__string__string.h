...
struct NativePromise__string__string : ::app::Fuse::Scripting::NativeMember
{
    ...
    void _ObjInit_1(::uString* name, ::uDelegate* func, ::uDelegate* resultConverter) { NativePromise__string__string___ObjInit_1(this, name, func, resultConverter); }
    void _ObjInit_2(::uString* name, ::uDelegate* futureFactory, ::uDelegate* resultConverter) { NativePromise__string__string___ObjInit_2(this, name, futureFactory, resultConverter); }

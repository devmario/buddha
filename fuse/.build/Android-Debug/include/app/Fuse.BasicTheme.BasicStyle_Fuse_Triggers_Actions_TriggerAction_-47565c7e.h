...
#ifndef __APP_FUSE_BASIC_THEME_BASIC_STYLE_FUSE_TRIGGERS_ACTIONS_TRIGGER_ACTION__47565C7E_H__
#define __APP_FUSE_BASIC_THEME_BASIC_STYLE_FUSE_TRIGGERS_ACTIONS_TRIGGER_ACTION__47565C7E_H__
...
struct BasicStyle_Fuse_Triggers_Actions_TriggerAction_bool_IsActive_Property;

struct BasicStyle_Fuse_Triggers_Actions_TriggerAction_bool_IsActive_Property__uType : ::app::Uno::UX::Property__bool__uType
{
};
...
struct BasicStyle_Fuse_Triggers_Actions_TriggerAction_bool_IsActive_Property : ::app::Uno::UX::Property__bool
{
    ::uStrong< ::app::Fuse::Triggers::Actions::TriggerAction*> _obj;

    void _ObjInit_1(::app::Fuse::Triggers::Actions::TriggerAction* obj) { BasicStyle_Fuse_Triggers_Actions_TriggerAction_bool_IsActive_Property___ObjInit_1(this, obj); }
};

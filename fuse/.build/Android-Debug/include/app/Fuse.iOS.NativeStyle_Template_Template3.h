...
#ifndef __APP_FUSE_I_O_S_NATIVE_STYLE_TEMPLATE_TEMPLATE3_H__
#define __APP_FUSE_I_O_S_NATIVE_STYLE_TEMPLATE_TEMPLATE3_H__
...
struct NativeStyle_Template_Template3 : ::app::Uno::UX::Template__Fuse_Controls_PlainTextEdit
{
    ...
    void _ObjInit_1(::app::Fuse::iOS::NativeStyle_Template* parent) { NativeStyle_Template_Template3___ObjInit_1(this, parent); }
};

...
#ifndef __APP_FUSE_CONTROLS_GRAPHICS_GRAPHICS_STYLE_FUSE_GESTURES_SCROLLER_BOO_113CB144_H__
#define __APP_FUSE_CONTROLS_GRAPHICS_GRAPHICS_STYLE_FUSE_GESTURES_SCROLLER_BOO_113CB144_H__
...
struct GraphicsStyle_Fuse_Gestures_Scroller_bool_UserScroll_Property;

struct GraphicsStyle_Fuse_Gestures_Scroller_bool_UserScroll_Property__uType : ::app::Uno::UX::Property__bool__uType
{
};
...
struct GraphicsStyle_Fuse_Gestures_Scroller_bool_UserScroll_Property : ::app::Uno::UX::Property__bool
{
    ::uStrong< ::app::Fuse::Gestures::Scroller*> _obj;

    void _ObjInit_1(::app::Fuse::Gestures::Scroller* obj) { GraphicsStyle_Fuse_Gestures_Scroller_bool_UserScroll_Property___ObjInit_1(this, obj); }
};

...
function getPlayLabel(count) {
	...
	switch (count) {
		//◎ 나는 소중한 사람이에요
	case 1:
		stringForReturn = "나는 이 세상에 하나밖에\n없는 소중한 사람이에요.";
		break;
	case 2:
		stringForReturn = "나는 사랑을 받으며\n자라고 있어요.";
		break;
	case 3:
		stringForReturn = "많은 사람이 내 몸과 마음이 건강하게\n자라도록 지켜주는 것을 알아요.";
		break;
	case 4:
		stringForReturn = "나는\n우리나라의 꿈나무예요.";
		break;
	case 5:
		...
		break;
	case 6:
		stringForReturn = "나는 언제나 자신감\n있게 행동하겠어요.";
		break;
	case 7:
		stringForReturn = "어떤 일을 하던‘나는 잘 할 수 있어.’\n하며 나를 응원하겠어요.";
		break;
	case 8:
		stringForReturn = "나는 새로운 일도\n두렵지 않아요.";
		break;
	case 9:
		stringForReturn = "착하고 지혜로운 나의\n참모습을 지켜나가겠어요.";
		break;
	...
	case 20:
		...
		break;
	case 21:
		stringForReturn = "내가 남들보다 조금 잘 하는 것이\n있다고 우쭐대지 않겠어요.";
		break;
	case 22:
	...
	case 28:
		...
		break;
	case 29:
		stringForReturn = "내 마음에 부끄럽지\n않게 행동하겠어요.";
		break;
	case 30:
		stringForReturn = "남에게 기대지 않고\n내 일을 스스로 하겠어요.";
		break;
	case 31:
		stringForReturn = "나를 위험에 빠뜨릴 수\n있는 거짓말을 하지 않겠어요.";
		break;
	case 32:
		stringForReturn = "다른 사람의 놀림에 당황하지\n않고 당당하게 행동하겠어요.";
		break;
	case 33:
	...
	case 34:
		...
		break;
	case 35:
		stringForReturn = "화나고 짜증나는 일도 한 번만\n참으면 마음이 편해진다는 것을 기억하겠어요.";
		break;

		//◎ 나는 행복한 사람이에요
	case 36:
		stringForReturn = "나는 날마다 행복한\n생각을 하겠어요.";
		break;
	case 37:
		stringForReturn = "나는 얼굴을 찌푸리는\n대신 환하게 웃겠어요.";
		break;
	case 38:
	...
	case 39:
		...
		break;
	case 40:
		stringForReturn = "연예인만 좋아하지 않고 다양한\n예술 작품에 관심을 갖겠어요.";
		break;
	case 41:
		stringForReturn = "컴퓨터나 게임은 시간을\n정해 두고 즐기겠어요.";
		break;
	case 42:
		stringForReturn = "인터넷을 이용할 때 소중한\n개인정보를 함부로 알려주지 않겠어요.";
		break;
	case 43:
	...
	case 48:
		...
		break;
	case 49:
		stringForReturn = "공부나 새로운 일을\n할 때는 계획을 먼저 세우겠어요.";
		break;
	case 50:
		stringForReturn = "공부를 조금 못해도\n실망하거나 포기하지 않겠어요.";
		break;
	case 51:
		stringForReturn = "나는 지금보다 훨씬 멋진\n모습으로 자랄 것을 믿어요.";
		break;
	case 52:
		stringForReturn = "한 번 시작한 일은\n끈기 있게 해내겠어요.";
		break;
	case 53:
		stringForReturn = "10년 뒤, 20년 뒤의 내 모습을 마음속에\n그려놓고 꿈을 이루기 위해 노력하겠어요.";
		break;

		//◎ 가족은 든든한 울타리에요
	case 54:
		stringForReturn = "가족의 모습은 다양하기 때문에 나와\n다른 가정도 이상한 눈길로 보지 않겠어요.";
		break;
	case 55:
		stringForReturn = "나는 부모님께 고마운 마음을\n가지고 부모님의 말씀을 잘 듣겠어요.";
		break;
	case 56:
		stringForReturn = "부모님이나 형제, 자매를 다른\n집과 비교하며 불평하지 않겠어요.";
		break;
	case 57:
		stringForReturn = "가족은 편한 사이지만 예의에\n벗어난 행동을 하지는 않겠어요.";
		break;
	case 58:
		stringForReturn = "가족에게 부드러운 표정으로\n다정하게 말하겠어요.";
		break;
	case 59:
		stringForReturn = "형제자매끼리 다투지\n않고 아끼며 돕겠어요.";
		break;
	case 60:
		stringForReturn = "가정에서 내 역할은 몸과 마음을\n건강하게 가꾸며 즐겁게 공부하는 것이에요.";
		break;
	case 61:
	...
	case 68:
		...
		break;
	case 69:
		stringForReturn = "나는 친구의 약점이나\n실수를 들추어내지 않겠어요.";
		break;
	case 70:
		stringForReturn = "나는 친구의 비밀을 남에게\n함부로 말하지 않겠어요.";
		break;
	case 71:
		stringForReturn = "난 친구가 없는 자리에서\n친구의 흉을 보지 않겠어요.";
		break;
	case 72:
		stringForReturn = "나는 친구에게 상처가 되는 말\n대신 용기를 주는 말을 하겠어요.";
		break;
	case 73:
		stringForReturn = "친구가 섭섭하게 대해도 화내지\n않고 ‘왜 그랬을까’를 먼저 생각하겠어요.";
		break;
	case 74:
		stringForReturn = "내 주장만 하지 않고 친구의\n말을 끝까지 들어주겠어요.";
		break;
	case 75:
		stringForReturn = "친구와 다투었을 때\n내가 먼저 화해하겠어요.";
		break;
	case 76:
		stringForReturn = "생김새나 차림새로 친구를\n무시하거나 따돌리지 않겠어요.";
		break;
	...
	case 103:
		...
		break;
	case 104:
		stringForReturn = "내게는 어린이가 할 수 없는\n일을 하지 않을 권리가 있어요.";
		break;
	case 105:
	...
	case 106:
		...
		break;
	case 107:
		stringForReturn = "나는 남자 또는 여자라는\n이유로 차별받지 않을 권리가 있어요.";
		break;
	case 108:
		stringForReturn = "나는 세상을 밝고\n행복하게 만드는 사람으로 자라겠어요.";
		break;
...
function playClick(arg) {
	...
	obj.title = getTitleLabel(obj.index + 1);

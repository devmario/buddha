...
// - - - - - - - - - -
// custom font
#define FONT_GLOBAL(fontSize)    ([[[Contents jsonData] objectForKey:@"font"] isEqualToString:@""] ? [UIFont systemFontOfSize:fontSize] : [UIFont fontWithName:[[Contents jsonData] objectForKey:@"font"] size:fontSize])
//
// - - - - - - - - - -
...
+ (void)audioPlayerWithRetainObject:(id)retainObject playURL:(NSURL *)url fileTypeHint:(NSString*)ftype volume:(CGFloat)volume numberOfLoops:(NSInteger)numberOfLoops;

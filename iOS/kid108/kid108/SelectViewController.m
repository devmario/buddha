...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [[MainPage getMain].navigationController pushViewController:[[[PlayPage alloc] initWithNewPosition:[[dict objectForKey:@"pos"] intValue] - 1] autorelease] animated:NO];
...
- (void)down:(id)sender {
    UIButton* bt = sender;
    bt.layer.backgroundColor = [UIColor lightGrayColor].CGColor;
}
...
- (void)setupButton:(UIButton*)bt {
    ...
    [bt setTitleColor:[UIColor whiteColor] forState:UIControlEventTouchDown];

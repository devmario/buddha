...
function getPlayLabel(count) {
	...
	switch (count) {
		//◎ 나는 소중한 사람이에요
	case 1:
		stringForReturn = "나는 이 세상에 하나밖에 없는 소중한 사람이에요.";
		break;
	case 2:
		stringForReturn = "나는 사랑을 받으며 자라고 있어요.";
		break;
	case 3:
		stringForReturn = "많은 사람이 내 몸과 마음이 건강하게 자라도록 지켜주는 것을 알아요.";
		break;
	case 4:
		stringForReturn = "나는 우리나라의 꿈나무예요.";
		break;
	case 5:
		stringForReturn = "나는 겉모습보다 속마음이 훨씬 예쁜 사람이에요.";
		break;
	case 6:
		stringForReturn = "나는 언제나 자신감 있게 행동하겠어요.";
		break;
	case 7:
		stringForReturn = "어떤 일을 하던‘나는 잘 할 수 있어.’하며 나를 응원하겠어요.";
		break;
	case 8:
		stringForReturn = "나는 새로운 일도 두렵지 않아요.";
		break;
	case 9:
		stringForReturn = "착하고 지혜로운 나의 참모습을 지켜나가겠어요.";
		break;

		//◎ 나는 향기로운 사람이에요
	case 10:
		stringForReturn = "나는 좋은 성격과 밝은 마음을 가꾸어가겠어요.";
		break;
	case 11:
		stringForReturn = "때때로 내 모습을 돌아보며 잘못을 고치겠어요.";
		break;
	case 12:
		stringForReturn = "나는 작은 일에 화내거나 짜증내지 않겠어요.";
		break;
	case 13:
		stringForReturn = "무조건 내가 옳다고 우기지 않겠어요.";
		break;
	case 14:
		stringForReturn = "내가 말한 것은 책임지고 지키겠어요.";
		break;
	case 15:
		stringForReturn = "일이 잘못되었을 때 남의 탓을 하기보다 내 잘못을 먼저 생각해 보겠어요.";
		break;
	case 16:
		stringForReturn = "나는 어려운 일도 슬기롭게 헤쳐 나갈 수 있어요.";
		break;
	case 17:
		stringForReturn = "나는 같은 실수를 반복하지 않겠어요.";
		break;
	case 18:
		stringForReturn = "나 혼자만 즐겁기 위해 다른 사람의 즐거움을 빼앗지 않겠어요.";
		break;
	case 19:
		stringForReturn = "남들보다 못하는 일이 있어도 한심하게 여기지 않겠어요.";
		break;
	case 20:
		stringForReturn = "나만의 특기를 찾아서 가꾸겠어요.";
		break;
	case 21:
		stringForReturn = "내가 남들보다 조금 잘 하는 것이 있다고 우쭐대지 않겠어요.";
		break;
	case 22:
		stringForReturn = "친구가 잘하는 것은 인정하고 칭찬하겠어요.";
		break;
	case 23:
		stringForReturn = "나는 친구를 시기하거나 질투하지 않겠어요.";
		break;

		//◎ 마음에 지혜를 담겠어요
	case 24:
		stringForReturn = "내 주변에서 일어나는 일에 호기심을 갖고 관찰하겠어요.";
		break;
	case 25:
		stringForReturn = "나는 좋은 책을 골라 읽고 책 속에 담긴 뜻을 생각해 보겠어요.";
		break;
	case 26:
		stringForReturn = "내 마음을 열고 친구나 동생에게도 배우겠어요. ";
		break;
	case 27:
		stringForReturn = "나는 실패를 부끄러워하지 않고 실패에서 더 많이 배우겠어요.";
		break;
	case 28:
		stringForReturn = "내게 주어진 일을 즐겁게 하겠어요.";
		break;
	case 29:
		stringForReturn = "내 마음에 부끄럽지 않게 행동하겠어요.";
		break;
	case 30:
		stringForReturn = "남에게 기대지 않고 내 일을 스스로 하겠어요.";
		break;
	case 31:
		stringForReturn = "나를 위험에 빠뜨릴 수 있는 거짓말을 하지 않겠어요.";
		break;
	case 32:
		stringForReturn = "다른 사람의 놀림에 당황하지 않고 당당하게 행동하겠어요.";
		break;
	case 33:
		stringForReturn = "슬픔이나 괴로움은 언젠가는 사라지는 것이므로 꿋꿋하게 견디겠어요.";
		break;
	case 34:
		stringForReturn = "쓸데없는 욕심과 고집으로 내 마음을 괴롭히지 않겠어요.";
		break;
	case 35:
		stringForReturn = "화나고 짜증나는 일도 한 번만 참으면 마음이 편해진다는 것을 기억하겠어요.";
		break;

		//◎ 나는 행복한 사람이에요
	case 36:
		stringForReturn = "나는 날마다 행복한 생각을 하겠어요.";
		break;
	case 37:
		stringForReturn = "나는 얼굴을 찌푸리는 대신 환하게 웃겠어요.";
		break;
	case 38:
		stringForReturn = "나보다 어렵고 불행한 사람을 보면서 ‘나는 행복해’ 하며 비교하지 않겠어요.";
		break;
	case 39:
		stringForReturn = "나보다 잘 사는 친구를 보면서 ‘나는 불행해’ 하는 생각도 하지 않겠어요.";
		break;
	case 40:
		stringForReturn = "연예인만 좋아하지 않고 다양한 예술 작품에 관심을 갖겠어요.";
		break;
	case 41:
		stringForReturn = "컴퓨터나 게임은 시간을 정해 두고 즐기겠어요.";
		break;
	case 42:
		stringForReturn = "인터넷을 이용할 때 소중한 개인정보를 함부로 알려주지 않겠어요.";
		break;
	case 43:
		stringForReturn = "내가 재미있게 할 수 있는 취미를 찾아 즐기겠어요.";
		break;
	case 44:
		stringForReturn = "용돈은 마구 써버리지 않고 계획을 세워서 알뜰하게 쓰겠어요.";
		break;
	case 45:
		stringForReturn = "나는 올바른 생활 습관을 갖겠어요.";
		break;

		//◎ 내 삶의 주인은 바로 나예요
	case 46:
		stringForReturn = "나는 희망의 꽃씨이므로 스스로 아끼고 보호하겠어요.";
		break;
	case 47:
		stringForReturn = "존경하는 사람을 정해두고 닮으려고 노력하겠어요.";
		break;
	case 48:
		stringForReturn = "가르침을 받을 수 있는 좋은 말을 마음에 새겨두겠어요.";
		break;
	case 49:
		stringForReturn = "공부나 새로운 일을 할 때는 계획을 먼저 세우겠어요.";
		break;
	case 50:
		stringForReturn = "공부를 조금 못해도 실망하거나 포기하지 않겠어요.";
		break;
	case 51:
		stringForReturn = "나는 지금보다 훨씬 멋진 모습으로 자랄 것을 믿어요.";
		break;
	case 52:
		stringForReturn = "한 번 시작한 일은 끈기 있게 해내겠어요.";
		break;
	case 53:
		stringForReturn = "10년 뒤, 20년 뒤의 내 모습을 마음속에 그려놓고 꿈을 이루기 위해 노력하겠어요.";
		break;

		//◎ 가족은 든든한 울타리에요
	case 54:
		stringForReturn = "가족의 모습은 다양하기 때문에 나와 다른 가정도 이상한 눈길로 보지 않겠어요.";
		break;
	case 55:
		stringForReturn = "나는 부모님께 고마운 마음을 가지고 부모님의 말씀을 잘 듣겠어요.";
		break;
	case 56:
		stringForReturn = "부모님이나 형제, 자매를 다른 집과 비교하며 불평하지 않겠어요.";
		break;
	case 57:
		stringForReturn = "가족은 편한 사이지만 예의에 벗어난 행동을 하지는 않겠어요.";
		break;
	case 58:
		stringForReturn = "가족에게 부드러운 표정으로 다정하게 말하겠어요.";
		break;
	case 59:
		stringForReturn = "형제자매끼리 다투지 않고 아끼며 돕겠어요.";
		break;
	case 60:
		stringForReturn = "가정에서 내 역할은 몸과 마음을 건강하게 가꾸며 즐겁게 공부하는 것이에요.";
		break;
	case 61:
		stringForReturn = "가족 모두가 해야 하는 집안일을 열심히 하겠어요.";
		break;
	case 62:
		stringForReturn = "학교에서 일어난 일을 부모님께 자주 말씀드리겠어요.";
		break;
	case 63:
		stringForReturn = "친척의 올바른 호칭을 알아두고 집안 행사에 즐겁게 참여하겠어요.";
		break;

		//◎ 친구는 내 인생의 보물이에요
	case 64:
		stringForReturn = "나와 친구들은 잘하는 일이 한 가지씩은 있어요.";
		break;
	case 65:
		stringForReturn = "나는 친구를 속이거나 함부로 대하지 않겠어요.";
		break;
	case 66:
		stringForReturn = "나는 친구가 어려울 때 도움을 주는 멋진 친구가 되겠어요.";
		break;
	case 67:
		stringForReturn = "나는 친구의 좋은 점을 배우겠어요.";
		break;
	case 68:
		stringForReturn = "나는 친구와의 약속을 소중히 생각하고 꼭 지키겠어요.";
		break;
	case 69:
		stringForReturn = "나는 친구의 약점이나 실수를 들추어내지 않겠어요.";
		break;
	case 70:
		stringForReturn = "나는 친구의 비밀을 남에게 함부로 말하지 않겠어요.";
		break;
	case 71:
		stringForReturn = "난 친구가 없는 자리에서 친구의 흉을 보지 않겠어요.";
		break;
	case 72:
		stringForReturn = "나는 친구에게 상처가 되는 말 대신 용기를 주는 말을 하겠어요.";
		break;
	case 73:
		stringForReturn = "친구가 섭섭하게 대해도 화내지 않고 ‘왜 그랬을까’를 먼저 생각하겠어요.";
		break;
	case 74:
		stringForReturn = "내 주장만 하지 않고 친구의 말을 끝까지 들어주겠어요.";
		break;
	case 75:
		stringForReturn = "친구와 다투었을 때 내가 먼저 화해하겠어요.";
		break;
	case 76:
		stringForReturn = "생김새나 차림새로 친구를 무시하거나 따돌리지 않겠어요.";
		break;

		//◎ 학교는 또 다른 집이에요
	case 77:
		stringForReturn = "학교는 공부만 하는 곳이 아니라 내가 성장하는 곳임을 알아요.";
		break;
	case 78:
		stringForReturn = "즐거운 마음으로 학교생활을 하겠어요.";
		break;
	case 79:
		stringForReturn = "나를 가르쳐주시는 선생님께 고마운 마음을 갖겠어요.";
		break;
	case 80:
		stringForReturn = "모두가 함께 쓰는 학교의 물건을 함부로 다루지 않겠어요.";
		break;
	case 81:
		stringForReturn = "교실은 친구와 함께 쓰는 곳이므로 정리정돈을 잘하겠어요.";
		break;
	case 82:
		stringForReturn = "수업시간에는 집중하고 친구의 공부를 방해하지 않겠어요.";
		break;
	case 83:
		stringForReturn = "예습과 복습을 잘 하고 준비물을 스스로 챙기겠어요.";
		break;
	case 84:
		stringForReturn = "값비싼 물건을 학교에 가져가서 자랑하지 않겠어요.";
		break;
	case 85:
		stringForReturn = "우리 반에 어떤 문제가 생기면 학급회의 때 해결방법을 찾아보겠어요.";
		break;
	case 86:
		stringForReturn = "급식은 남기지 않고 맛있게 먹겠어요.";
		break;
	case 87:
		stringForReturn = "학교 도서관을 자주 이용하겠어요.";
		break;

		//◎ 우리는 어울려 살아요
	case 88:
		stringForReturn = "나는 한국 사람인 동시에 지구에 사는 사람임을 잊지 않겠어요.";
		break;
	case 89:
		stringForReturn = "다른 나라의 어린이에게도 관심을 갖겠어요.";
		break;
	case 90:
		stringForReturn = "이 땅에 함께 사는 생명들을 귀하게 여기고 환경을 보호하겠어요.";
		break;
	case 91:
		stringForReturn = "피부색이 다른 사람을 무시하거나 차별하지 않겠어요.";
		break;
	case 92:
		stringForReturn = "우리보다 가난한 나라의 문화도 존중하겠어요.";
		break;
	case 93:
		stringForReturn = "몸이 불편한 사람을 불쌍한 눈으로 보지 않겠어요.";
		break;
	case 94:
		stringForReturn = "다른 사람을 돕는 봉사활동에 적극적으로 참여하겠어요.";
		break;
	case 95:
		stringForReturn = "형편이 어려운 지구촌 사람에게 따뜻한 마음을 베풀겠어요.";
		break;
	case 96:
		stringForReturn = "내가 누리는 것들은 다른 사람의 땀으로 마련된 것임을 잊지 않겠어요";
		break;
	case 97:
		stringForReturn = "신호등 지키기처럼 사회가 정한 규칙을 잘 지키겠어요.";
		break;
	case 98:
		stringForReturn = "내 집이라도 소리 지르거나 뛰면서 이웃에 피해를 주지 않겠어요.";
		break;
	case 99:
		stringForReturn = "거리에서 아는 사람을 만나면 먼저 인사하겠어요.";
		break;
	case 100:
		stringForReturn = "내 생각이 틀릴 때도 많다는 것을 기억하겠어요.";
		break;
	case 101:
		stringForReturn = "나와 의견이 다른 것을 나쁘다고 말하지 않겠어요.";
		break;
	case 102:
		stringForReturn = "내 잘못은 그냥 넘어가면서 남의 잘못은 따져 묻는 일은 하지 않겠어요.";
		break;

		//◎ 나는 존중받을 권리가 있어요
	case 103:
		stringForReturn = "어린이는 보호받을 권리가 있으므로 위험할 때는 주변에 도움을 청하겠어요.";
		break;
	case 104:
		stringForReturn = "내게는 어린이가 할 수 없는 일을 하지 않을 권리가 있어요.";
		break;
	case 105:
		stringForReturn = "나는 건강을 지키기 위해서 마음껏 뛰어놀겠어요.";
		break;
	case 106:
		stringForReturn = "불량식품이나 위험한 장난감을 가까이 하지 않겠어요.";
		break;
	case 107:
		stringForReturn = "나는 남자 또는 여자라는 이유로 차별받지 않을 권리가 있어요.";
		break;
	case 108:
		stringForReturn = "나는 세상을 밝고 행복하게 만드는 사람으로 자라겠어요.";
		break;
